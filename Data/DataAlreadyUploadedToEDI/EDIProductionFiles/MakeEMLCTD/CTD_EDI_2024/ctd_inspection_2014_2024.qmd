...
write_csv(ctd_reprocessed, "ctd_2013_2024.csv")
...
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/Raw_CTD/CTD_Maintenance_Log.csv", "ctd_maintenancelog_2013_2024.csv")

# download QAQC file
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/Raw_CTD/CTD_code/ctd_QAQC.R", "ctd_qaqc_2013_2024.R")
...
y2024 <-vars_to_plot %>%
  map(plot_var, year = 2024, site = 20)
...
yy2024 <- vars_to_plot %>%
  map(plot_var_sites, reservoirs = "FCR", year = 2024, site = c(10,20,30,40))

htmltools::tagList(list(yy2024))
