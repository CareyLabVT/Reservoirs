...
template_table_attributes(
 path = folder,
 data.path = folder,
 data.table = c('ctd_2013_2025.csv','site_descriptions.csv', 'ctd_maintenancelog_2013_2025.csv') ,
 write.file=TRUE)
...
eml_file <- make_eml(path = getwd(),
         ...
         data.table = c("ctd_2013_2025.csv",
                        "site_descriptions.csv", 
                        "ctd_maintenancelog_2013_2025.csv"),
#         data.table.name = c("ctd_2013_2025",
#                             "site_descriptions",
#                             "ctd_maintenancelog_2013_2025"),
         ...
         other.entity = c('ctd_QAQC_2018_2025.R', 
                          'ctd_inspection_2013_2025.qmd',
                          "helper_scripts.zip"),
#         other.entity.name = c('ctd_QAQC_2018_2025', 
#                               "ctd_inspection_2013_2025",
#                               "helper_scripts"),
         other.entity.description = c('High-level QAQC script used to process data from 2018-2025: references scripts in helper_scripts.zip', 
                                      'Script that plots the data for visual inspection during the publishing process',
                                      "Scripts used to compile casts and apply QAQC as referenced by CTD_QAQC_2018_2025.R"),
         temporal.coverage = c("2013-03-07", "2025-12-02"),
         maintenance.description = "ongoing",
         user.domain = "EDI",
         user.id = "ccarey", #21 up to date 1/15
         package.id = "edi.1113.22", 
