...
write_csv(qaqc, "ctd_2013_2025.csv")
...
# download QAQC file
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/Raw_CTD/CTD_code/ctd_QAQC.R", "ctd_qaqc_2018_2025.R")
...
ctd_edi <- read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/1113/20/97c1b55fdb8308b18e63eb8eae9b9bfa")

# for katie only: ctd_edi <- read_csv("~/GitHubRepos/CareyLabVT/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLCTD/CTD_EDI_2025/ctd_2013_2025.csv")
...
plot_var <- function(var_name, 
  ...
  qaqc_plotly <- data %>%
    ...
    scale_color_gradientn(colours = blue2green2red(100), na.value="gray", trans = "log") +
    scale_y_reverse() +
    geom_point() +
    ggtitle(year) +
...
y2025 <-vars_to_plot %>%
  map(plot_var, year = 2021, site = c(50, 51))
