...
output_file <- paste0(folder, "misc_data_files/Catwalk_first_QAQC_2021.csv")#name of the output file
...
#catdata<- read.csv("Catwalk_first_QAQC_2021.csv")
...
#take out maintenance points for the 5m DO from 2018-2020
catdata_flag <- catdata_flag %>%
  mutate(
    Flag_DO_5 = ifelse(DateTime >= "2018-09-25 10:40" & DateTime<"2018-09-25 10:55",2, Flag_DO_5),
    ...
    Flag_DO_5 = ifelse(DateTime >= "2019-06-17 13:50" & DateTime < "2019-06-17 15:40" & 
                         (! is.na(RDO_mgL_5)) ,2, Flag_DO_5),
    ...
    Flag_DO_5 = ifelse(DateTime >= "2020-07-06 14:10" & DateTime < "2020-07-06 14:40" & 
                         (! is.na(RDO_mgL_5)) ,2, Flag_DO_5),
    ...
    RDO_mgL_5 = ifelse(DateTime >= "2020-07-06 14:10" & DateTime < "2020-07-06 14:40" &
                         (! is.na(RDO_mgL_5)),NA, RDO_mgL_5),
    Flag_DO_5 = ifelse(DateTime >= "2020-07-13 13:00" & DateTime < "2020-07-13 14:50" & 
                         (! is.na(RDO_mgL_5)) ,2, Flag_DO_5),
...
#take out maintenance points for the 9m DO from 2018-2020
catdata_flag <- catdata_flag %>%
  mutate(
    Flag_DO_9 = ifelse(DateTime >= "2018-11-19 15:00" & DateTime < "2018-11-20 12:20" & 
                         (! is.na(RDO_mgL_9)) ,2, Flag_DO_9),
    ...
    Flag_DO_9 = ifelse(DateTime >= "2020-12-02 15:00" & DateTime < "2020-12-02 18:00" & 
                         (! is.na(RDO_mgL_9)) ,2, Flag_DO_9),
    ...
    RDO_mgL_9 = ifelse(DateTime >= "2020-12-02 15:00" & DateTime < "2020-12-02 18:00" &
                         (! is.na(RDO_mgL_9)),NA, RDO_mgL_9),
    Flag_DO_9 = ifelse(DateTime >= "2021-02-08 17:40" & DateTime < "2021-02-08 18:10" & 
                         (! is.na(RDO_mgL_9)) ,2, Flag_DO_9),
...
Cond_21=catdata_flag%>%
  filter(DateTime>"2020-05-28 00:00" & DateTime< "2020-06-10 00:00")%>%
...
SpCond_21=catdata_flag%>%
  filter(DateTime>"2020-08-28 12:00" & DateTime< "2020-08-29 23:59")%>%
...
write.csv(catdata_all, paste0(folder, '/Catwalk_EDI_2021.csv'), row.names = FALSE)
