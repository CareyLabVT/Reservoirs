...
- compare with CTD and add in flags as needed
...
catdata_published <- catdata[catdata$DateTime<="2018-12-16",] #Need to fix this
catdata_published <- catdata_published[!is.na(catdata_published$Flag_All),]
catdata_flag <- catdata[catdata$DateTime>"2020-01-01",] #Need to fix this
...
#Deal with when the sesnors were up ###(SHOULD I BE DOING ANYTHING FOR 1m here?)
maint = read.csv("CAT_MaintenanceLog_2020.txt")
maint = maint[!grepl("EXO",maint$parameter),]
