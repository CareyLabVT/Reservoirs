...
catdata_adj = catdata_flag_test%>%
  mutate(
     # 5 meters #### READ NOTE: These changes were for 2019, I didn't delete so the RDO 5 adjusted column still appeared for plots below 
    #Add a flag that this period was suspect
     ...
     Flag_DO_9 = ifelse(DateTime<"2020-08-17 12:50:00" & DateTime> "2020-08-11 15:00:00",6, Flag_DO_9),
     RDO_mgL_9_adjusted = ifelse(DateTime<"2020-08-17 12:50:00" & DateTime> "2020-08-11 15:00:00", 
                                RDO_mgL_9 + (as.numeric(difftime("2020-08-17 12:50:00","2020-08-12 15:00:00", units = "mins")))/6500, #A different square root adjustment here. was a sqrt before, I removed that part
                                RDO_mgL_9),
     ...
     RDO_mgL_9_adjusted = ifelse(DateTime<"2020-08-24 10:40:00" & DateTime> "2020-08-19 20:00:00", 
                                RDO_mgL_9 + (as.numeric(difftime("2020-08-24 10:40:00","2020-08-19 20:00:00", units = "mins")))/6500, #A linear adjustment here
                                RDO_mgL_9_adjusted),
     RDOsat_percent_9_adjusted = ifelse(DateTime<"2020-08-24 10:40:00" & DateTime> "2020-08-19 20:00:00", 
                                RDOsat_percent_9 + as.numeric(difftime("2020-08-24 10:40:00","2020-08-19 20:00:00", units = "mins"))/6500/11.3*100,
     ...
     RDO_mgL_9_adjusted = ifelse(DateTime< "2020-09-02 10:50:00" & DateTime> "2020-08-26 12:00:00", 
                                RDO_mgL_9 + (as.numeric(difftime("2020-09-02 10:50:00", "2020-08-26 12:00:00", units = "mins")))/10000, #A linear adjustment here
                                RDO_mgL_9_adjusted),
     RDOsat_percent_9_adjusted = ifelse(DateTime< "2020-09-02 10:50:00" & DateTime> "2020-08-26 12:00:00", 
                                RDOsat_percent_9 + as.numeric(difftime("2020-09-02 10:50:00", "2020-08-26 12:00:00", units = "mins"))/10000/11.3*100,
                                RDOsat_percent_9_adjusted),
     ...
     RDO_mgL_9_adjusted = ifelse(DateTime< "2020-09-09 17:50:00" & DateTime> "2020-09-05 06:00:00", 
                                RDO_mgL_9 + (as.numeric(difftime("2020-09-09 17:50:00", "2020-09-05 06:00:00", units = "mins")))/4000, #A linear adjustment here
                                RDO_mgL_9_adjusted),
     RDOsat_percent_9_adjusted = ifelse(DateTime< "2020-09-09 17:50:00" & DateTime> "2020-09-05 06:00:00", 
                                RDOsat_percent_9 + as.numeric(difftime("2020-09-09 17:50:00", "2020-09-05 06:00:00", units = "mins"))/4000/11.3*100,
                                RDOsat_percent_9_adjusted))
...
plot = catdata_adj%>%
  ...
  geom_line(aes(y = RDO_mgL_5_adjusted), color = "blue")+
