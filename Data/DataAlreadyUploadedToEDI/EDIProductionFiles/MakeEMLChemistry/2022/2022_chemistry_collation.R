# 2022 nutrient chemistry collation - 29Mar2023
#includes TNTP, DOC, and np 20201
#Note: flags are aggregated without commas for final EDI upload
#NOTE: the following samples will be rerun and need to integrate/average/select values appropriately for 2023 data pub (in 2024)

library(tidyverse)
library(dplyr)
library(lubridate)

TNTP <- read.csv("./collation/2021/2022_TNTP_collation.csv")
