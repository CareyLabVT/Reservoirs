...
new_chem <- read_csv("./2023_chemistry_collation_final_nocommas_OLDMDL.csv") |> 
  select(-1)
...
```{r save the data}
write.csv(all_chem, file.path("./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLChemistry/2023/Data/Chemistry_2013-2023.csv"), row.names=FALSE)
```
