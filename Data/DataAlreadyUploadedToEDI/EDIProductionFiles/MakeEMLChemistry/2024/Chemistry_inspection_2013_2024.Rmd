...
ggplot(subset(all_chem_long, Site=="50" & Reservoir=="BVR"), aes(x = as.Date(DateTime), y = value, col=Depth_m)) +
  geom_point(cex=2) +
...
ggplot(subset(all_chem_long, Reservoir=='FCR' & Site =='50'), aes(x = as.Date(DateTime), y = value, col=Depth_m)) +
  geom_point(cex=2) +
...
# CCR only; site 50
ggplot(subset(all_chem_long, Reservoir=='CCR' & Site =='50'), aes(x = as.Date(DateTime), y = value, col=Depth_m)) +
  geom_point(cex=2) +
  facet_grid(metric ~ Site, scales='free') +
  scale_x_date("Date", date_labels = "%b %y") +
  scale_y_continuous("Concentration") +
