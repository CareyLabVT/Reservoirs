...
data <- read.csv("./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLContinuumDischarge/2019_Continuum_Discharge.csv")
data2 <- read.csv('./Data/DataNotYetUploadedToEDI/Raw_inflow/Wetland_Discharge_Data_2020.csv')
