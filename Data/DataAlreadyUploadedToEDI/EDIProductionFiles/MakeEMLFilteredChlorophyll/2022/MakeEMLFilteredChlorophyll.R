...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLFilteredChlorophyll/2022"
...
make_eml(
  ...
  data.table = c("manual_chlorophyll_2014_2022.csv", 'site_descriptions.csv'),
  data.table.name = c("manual_chlorophyll_2014_2022", 'site_descriptions'), 
  data.table.description = c("Manual chlorophyll a data at multiple sites","Sampling site descriptions with latitude and longitude" ),
  other.entity = 'chla_qaqc_2014_2022.R',
  other.entity.name = "chla_qaqc_2014_2022",
