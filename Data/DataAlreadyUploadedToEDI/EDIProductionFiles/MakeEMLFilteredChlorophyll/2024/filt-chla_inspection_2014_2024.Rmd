...
filt_chla_qaqc(
  ...
  historic_file = "../../../../DataNotYetUploadedToEDI/Raw_chla/historic_filt_chla_2014_2022.csv",
...
inUrl1  <- "https://pasta-s.lternet.edu/package/data/eml/edi/52/29/d321a924e9d6a839366647a8f942204e" 
infile1 <- tempfile()
...
# Use Gsheet because you don't need to authenticate it.
 ...
 write.csv(maint_file, "FiltChla_maintenancelog_2014_2024.csv", row.names = F)
```
