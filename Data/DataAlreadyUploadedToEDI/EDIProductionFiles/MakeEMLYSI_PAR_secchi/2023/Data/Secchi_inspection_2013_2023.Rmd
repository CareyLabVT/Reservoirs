...
secchi_cleaned$Site[secchi_cleaned$DateTime == "2022-05-09 11:03:00" &
                 secchi_cleaned$Secchi_m == 1.60] <- 50
...
```{r save the data}
write.csv(secchi_cleaned,file.path("~/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLYSI_PAR_secchi/2023/Data/Secchi_depth_2013-2023.csv"), row.names=FALSE)
