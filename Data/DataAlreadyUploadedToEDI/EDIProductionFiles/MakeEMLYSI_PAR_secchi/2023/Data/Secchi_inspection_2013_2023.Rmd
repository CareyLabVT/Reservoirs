...
#catch some weird datetime issue that affects 2013-2020 secchi data (not 2021 - present) 
secchi$DateTime[year(secchi$DateTime) <= 2020] <- 
  secchi$DateTime[year(secchi$DateTime) <= 2020] + 4*60*60 #4 hrs
#note - added on 20Jan24 - make sure to DELETE this code during 2025 EDI dayz!!! ~HLW
```
...
#site was digitized incorrectly once and correctly another time

secchi_cleaned <- secchi_cleaned |> filter(!(DateTime == "2022-07-25 12:20:00" & Secchi_m == 1.35))
#secchi depth was digitized incorrectly once and correctly another time
