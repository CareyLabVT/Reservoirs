---
title: "Secchi_inspection_2018_2023"
...
```{r save the data}
write.csv(secchi,file.path("~/Reservoirs/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEMLYSI_PAR_secchi/2023/Data/Secchi_depth_2013-2023.csv"), row.names=FALSE)
```
