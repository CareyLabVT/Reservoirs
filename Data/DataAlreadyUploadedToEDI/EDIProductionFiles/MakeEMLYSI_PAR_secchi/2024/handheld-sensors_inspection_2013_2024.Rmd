...
# current_df <- secchi_qaqc(data_file = 'https://docs.google.com/spreadsheets/d/1EXxvt4zke3M-RdJIG5wWB-1KVTSM7DOAx2Xnng5NXbI/edit?gid=0#gid=0',
#             gsheet_data = TRUE,
...
# MAKE SURE TO UPDATE THE PASTA FROM THE VERSION YOU WANT
                                                                   ### CHANGE THIS NUMBER BELOW
                                                                              ##
 current_df <-read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/1140/1/54bda3bdebca2d1488221371a0c4ab8a" )
...
#look at 2024 secchi
a <- ggplot(data = subset(secchi_long, year(DateTime) %in% c(2024)), 
...
# 
# 
# write_csv(current_df, 'Secchi_2013_2024.csv')
# #list.files()
```

```{r Save maintlog and function, include=FALSE, eval=FALSE}
# Maintenance Log
# download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/Secchi/maintenance_log.csv", "Secchi_maintenancelog_2013_2024.csv")
# 
# # qaqc function
# download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Scripts/L1_functions/secchi_create.R", "Secchi_qaqc_2013_2024.R")
```