...
# MAKE SURE TO UPDATE THE PASTA FROM THE VERSION YOU WANT
                                                                ...
                                                                ### CHANGE THIS NUMBER BELOW 
                                                                             ##      
 current_df <-read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/157/27/6b78ab905a142b5dcc29044b83bae676")
...
dups <- dups%>%
  select(DateTime, RECORD, ThermistorTemp_C_7,  
         EXOTemp_C_1.5, EXOTemp_C_9, LvlPressure_psi_13) #there is no EXOTemp_C_9 col????
