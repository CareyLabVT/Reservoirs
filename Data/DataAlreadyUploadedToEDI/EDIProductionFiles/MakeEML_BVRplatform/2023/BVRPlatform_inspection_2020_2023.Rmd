...
<<<<<<< HEAD
L1 <- read_csv("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/bvre-waterquality_L1.csv")%>%rename(Depth_m_13 = LvlDepth_m_13)
=======
...
>>>>>>> 632578c1e3a2ca18b8f2029aef820caed80e0138
...
# MAKE SURE TO UPDATE THE PASTA FROM THE VERSION YOU WANT
                                                                ...
                                                                ### CHANGE THIS NUMBER BELOW 
                                                                             ##      
 current_df <-read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/157/27/c467263033e8e2bbc60410567f2531c2")
...
dups <- dups%>%
  select(DateTime, RECORD, ThermistorTemp_C_7,  
         EXOTemp_C_1.5, EXOTemp_C_9, LvlPressure_psi_13)
...
#crashes here! - says that Depth_m doesn't exist so issue with col names?
qaqc_bvr(data_file= current_df,
         data2_file = NULL,
         maintenance_file = "https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_maintenance_log.csv", 
         output_file = "new_df", 
         start_date = NULL, 
...
# make the plots
outputs <- lapply(dx, all_plot,y_lab = "Meters", y_lab2 = "Meters", Use_plotly=T)
...
# make the plots
outputs <- lapply(dx, all_plot, y_lab = "uScm or mg/L", y_lab2 = "uScm or mg/L", Use_plotly=F)
...
# make the plots
outputs <- lapply("EXOTurbidity_FNU_1.5", all_plot, y_lab="FNU", y_lab2="FNU", Use_plotly=F)
...
# Depth offsets
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_Depth_offsets.csv",
              "BVRPlatform_Depth_offsets_2020_2023.csv")

# Finding depth function
download.file("https://raw.githubusercontent.com/LTREB-reservoirs/vera4cast/main/targets/target_functions/find_depths.R",
              "find_depths.R")

# Download Heather's code to make BVR water level and then need to run it. 
download.file("https://raw.githubusercontent.com/hlwander/bvr_glm/master/inputs/water_level/WaterLevel_BVR.Rmd", "BVRPlatform_WaterLevel_BVR_2015_2022.Rmd")
