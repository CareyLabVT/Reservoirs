...
if (is.na(file.size(infile1))) download.file(inUrl1,infile1,method="auto")
 ...
 historic <-read_csv(infile1)%>%
   rename("LvlDepth_m_13" = Depth_m_13)

```

```{r Read in current L1 file, include=FALSE}

#L1 <- read_csv("BVR_L1.csv")
...
# make the plots
outputs <- lapply(dx, all_plot,y_lab = "mg/L or % sat", y_lab2 = "mg/L or % sat", Use_plotly=F)
...
write_csv(current_df, "BVRPlatform_2018_2023.csv")
...
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_Depth_offsets.csv",
              "BVR_Depth_offsets_2020_2023.csv")
