...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_BVRplatform/2024"
...
template_table_attributes(
 path = folder,
 data.path = folder,
 data.table = c('bvre-waterquality_2020_2024.csv','bvre-waterquality_maintenancelog_2020_2024.csv',
                'bvre-Ssensorstring_2016_2020.csv', "bvre_waterlevel_2009_2024.csv") ,
 write.file=TRUE)
...
make_eml(path = folder,
         ...
         data.table = c('bvre-waterquality_2020_2024.csv', 'bvre-waterquality_maintenancelog_2020_2024.csv', 'bvre-waterquality_depth_offsets_2020_2024.csv',
                        'bvre-sensorstring_2016_2020.csv', 'bvre-waterlevel_2009_2024.csv'),
         ...
         data.table.description = c("Water quality parameters measured at Beaverdam Reservoir during 2020-2024",
         ...
         other.entity = c('bvre-waterquality_qaqc_2020_2024.R', 'bvre-waterquality_inspection_2020_2024.Rmd',
                           'find_depths.R', 'Plotting_function.R', 'bvre-sensorstring_qaqc_2016_2020.R',
                          "bvre-waterlevel_qaqc_2009_2024.R",
         ...
         temporal.coverage = c("2009-09-01", "2024-12-31"),
         ...
         user.id = "ccarey",
         user.domain = 'EDI',
        # package.id = "edi.157.35") # Put your package.id here, followed by .1 (for 1st version). This is for staging
         package.id = "edi.725.5") # This is for the final version
