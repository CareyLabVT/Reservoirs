...
current_time_end= force_tz(as.POSIXct("2024-12-31 23:59:00"), tzone = "EST")
```
...
man_files <- c('https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/BVRPlatform/BVR_manual_2020_2023.csv',
...
state_cat <- tibble(data_file = ds,
                    ...
                    maintenance_file = rep("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_maintenance_log.csv",each=2),
                    output_file = I(list(NULL, NULL)),
                    start_date = c(ymd_hms("2020-06-18 17:55:00", tz="EST"), ymd_hms("2023-12-31 23:59:00", tz="EST")),
...
# Bind all the QAQC files from above
  current_df <- dplyr::bind_rows(bvr_files)
...
```{r Make current csv, include=FALSE}
...
write_csv(current_df, "bvre-waterquality_2020_2024.csv")
...
# Maintenance Log
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_maintenance_log.csv", "bvre-waterquality_maintenancelog_2020_2024.csv")

# qaqc function
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/R/edi_qaqc_function.R", "bvre-waterquality_qaqc_2020_2024.R")
...
# Depth offsets
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_Depth_offsets.csv", "bvre-waterquality_depth_offsets_2020_2024.csv")
