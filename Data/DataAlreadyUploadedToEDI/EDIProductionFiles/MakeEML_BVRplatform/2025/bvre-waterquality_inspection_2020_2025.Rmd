...
# source("bvre-waterquality_qaqc_2020_2025-test.R")
...
file_name <- "bvre-waterquality_2020_2025.csv"

qaqc_function <- "bvre-waterquality_qaqc_2020_2025.R"

maintenance_log <- "bvre-waterquality_maintenancelog_2020_2025.csv"

depth_offset <- "bvre-waterquality_depth_offsets_2020_2025.csv"
...
edi_link <- "https://pasta-s.lternet.edu/package/data/eml/edi/157/39/37e2587d2ab477068b295f97f1598cf9"  
...
ds <- c(
  'https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/bvre-waterquality_legacy_2020_2023.csv',
  "https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/refs/heads/bvre-platform-data-qaqc/bvre-waterquality_legacy_2024.csv",
  
  
  # THE CURRENT YEARS FILE
  'https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data/bvre-waterquality.csv',
...
'https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/BVRPlatform/BVR_manual_2020_2023.csv',
'https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/refs/heads/master/BVRPlatform/BVR_manual_2024_2025.csv'

)


# QAQC all the data through the qaqc function

current_df <- qaqc_bvr(data_file = ds,
                      # maintenance_file = "bvre-waterquality_maintenancelog_2020_2025_test.csv",
                    ...
                    output_file = NULL,
                    start_date = ymd_hms("2020-06-18 17:55:00", tz="EST"), 
                    end_date = Sys.Date())
   ...
   raw <- raw%>%
     select(-c("EXO_Date", "EXO_Time"))%>%
      mutate(across(ThermistorTemp_C_1:LvlTemp_C_13, ~ifelse(.x >180, NA, .x)),
             ...
             Site = 50,
             RDO_mgL_8 = RDO_mgL_6,
             RDOTemp_C_8 = RDOTemp_C_6,
             RDOsat_percent_8 = RDOsat_percent_6)
...
# Check for any gaps longer than 30 minutes in the record for the current year
 ...
 bvr2 <- current_df%>%
  select(DateTime, starts_with("EXO"), Flag_EXOTemp_C_1.5)|>
  filter(Flag_EXOTemp_C_1.5!=7)
  #filter(DateTime>current_time_start)

  for(i in 2:length(bvr2$EXOTemp_C_1.5)){ #this identifies if there are any data gaps in the long-term record, and where they are by record number
...
Let's look at the flag Frequency for each variable. As a reminder here are the flag codes
 ...
 6: values adjusted using an offset or linear adjustment with code in maintenance log
 
 7: missing data
 
 8: sensor moved to a new position and need to create a new data column
...
# Take out Temperature values 
  ...
  ggplot(All_temp)+
    ...
    facet_wrap(.~factor(Sensor, levels=c("ThermistorTemp_C_1", "ThermistorTemp_C_2", "EXOTemp_C_1.5", "ThermistorTemp_C_3", "ThermistorTemp_C_4","ThermistorTemp_C_5","ThermistorTemp_C_6","RDOTemp_C_6","ThermistorTemp_C_7","ThermistorTemp_C_8","RDOTemp_C_8","ThermistorTemp_C_9","EXOTemp_C_9","ThermistorTemp_C_10","ThermistorTemp_C_11","ThermistorTemp_C_12","ThermistorTemp_C_13", "RDOTemp_C_13", "LvlTemp_C_13")))+
    theme_bw()
...
# Maintenance Log
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_maintenance_log.csv", maintenance_log)

# qaqc function
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/R/edi_qaqc_function.R", qaqc_function)
...
# Depth offsets
download.file("https://raw.githubusercontent.com/FLARE-forecast/BVRE-data/bvre-platform-data-qaqc/BVR_Depth_offsets.csv", depth_offset)
...
download.file("https://raw.githubusercontent.com/hlwander/bvr_glm/master/inputs/water_level/WaterLevel_BVR.Rmd", "bvre_daily_waterlevel_vol_2015_2022.Rmd")

## Made files locally for 2025 data. Will figure out a better way to make the file later. 
# # BVR water level file
# download.file("https://raw.githubusercontent.com/abreefpilz/Reservoirs/master/Data/DataNotYetUploadedToEDI/Raw_waterlevel/BVR/BVR_WaterLevel_2009_2023.csv", "bvre-waterlevel_2009_2024.csv")
# 
# # BVR water level QAQC script
# download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/Raw_waterlevel/BVR/BVR_WaterLevel_qaqc_2029_2023.R", "bvre-waterlevel_qaqc_2009_2024.R")
