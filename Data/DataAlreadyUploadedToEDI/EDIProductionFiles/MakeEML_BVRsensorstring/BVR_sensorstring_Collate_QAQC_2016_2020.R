...
hobo <- hobo1[ !grepl("BVR_1_5m*", hobo1) ]#take out the EXO data
...
names(do10) <- c("DateTime", "MiniDotTemp_C_10","MiniDotObs_mgL_10", "MiniDotSat_percent_10")
...
names(do5) <- c("DateTime", "MiniDotTemp_C_5","MiniDotObs_mgL_5", "MiniDotSat_percent_5")
...
#check out the plots
plot(do$DateTime,do$MiniDotObs_mgL_10, type="l")
points(do$DateTime, do$MiniDotObs_mgL_5, type='l', col="red")
...
myfiles <- list.files(pattern = "BVR_1_5m*")
...
colnames(BVR_EXO)=c("DateTime","EXOChla_RFU_1_5","EXOChla_ugL_1_5","EXOCond_uScm_1_5","EXO_depth_m",
                        "EXOfDOM_RFU_1_5", "EXOfDOM_QSU_1_5",
                        "EXODOsat_percent_1_5","EXODO_mgL_1_5","EXO_pressure_psi",
                        "EXOSpCond_uScm_1_5","EXOBGAPC_RFU_1_5", "EXOBGAPC_ugL_1_5",
                        "EXOTDS_mgL_1_5","EXOTurbidity_FNU_1_5","EXO_wiper_V",
                        "EXOTemp_C_1_5","EXO_battery_V")
...
Chla_RFU_1_5_mean <- mean(BVR_sensor_string$EXOChla_RFU_1_5, na.rm = TRUE)
Chla_ugL_1_5_mean <- mean(BVR_sensor_string$EXOChla_ugL_1_5, na.rm = TRUE)
BGAPC_RFU_1_5_mean <- mean(BVR_sensor_string$EXOBGAPC_RFU_1_5, na.rm = TRUE)
BGAPC_ugL_1_5_mean <- mean(BVR_sensor_string$EXOBGAPC_ugL_1_5, na.rm = TRUE)
Chla_RFU_1_5_threshold <- EXO_FOULING_FACTOR * sd(BVR_sensor_string$EXOChla_RFU_1_5, na.rm = TRUE)
Chla_ugL_1_5_threshold <- EXO_FOULING_FACTOR * sd(BVR_sensor_string$EXOChla_ugL_1_5, na.rm = TRUE)
BGAPC_RFU_1_5_threshold <- EXO_FOULING_FACTOR * sd(BVR_sensor_string$EXOBGAPC_RFU_1_5, na.rm = TRUE)
BGAPC_ugL_1_5_threshold <- EXO_FOULING_FACTOR * sd(BVR_sensor_string$EXOBGAPC_ugL_1_5, na.rm = TRUE)
...
sd_fDOM_QSU <- sd(BVR_sensor_string$EXOfDOM_QSU_1_5, na.rm = TRUE) #deteriming the standard deviation of fDOM data 
sd_fDOM_RFU <- sd(BVR_sensor_string$EXOfDOM_RFU_1_5, na.rm = TRUE)
mean_fDOM_QSU <- mean(BVR_sensor_string$EXOfDOM_QSU_1_5, na.rm = TRUE) #deteriming the standard deviation of fDOM data 
mean_fDOM_RFU <- mean(BVR_sensor_string$EXOfDOM_RFU_1_5, na.rm = TRUE)
...
sd_cond <- sd(BVR_sensor_string$EXOCond_uScm_1_5, na.rm = TRUE)
sd_spcond <-sd(BVR_sensor_string$EXOSpCond_uScm_1_5, na.rm = TRUE)
sd_TDS <- sd(BVR_sensor_string$EXOTDS_mgL_1_5, na.rm = TRUE)
mean_cond <- mean(BVR_sensor_string$EXOCond_uScm_1_5, na.rm = TRUE)
mean_spcond <-mean(BVR_sensor_string$EXOSpCond_uScm_1_5, na.rm = TRUE)
mean_TDS <- mean(BVR_sensor_string$EXOTDS_mgL_1_5, na.rm = TRUE)
...
sd_Turbidity_FNU <- sd(BVR_sensor_string$EXOTurbidity_FNU_1_5, na.rm = TRUE) #deteriming the standard deviation of fDOM data 
mean_Turbidity_FNU <- mean(BVR_sensor_string$EXOTurbidity_FNU_1_5, na.rm = TRUE) #deteriming the standard deviation of fDOM data 
...
Temp1and0.1=BVR_sensor_string%>%
  ...
  geom_point(aes(y=EXOTemp_C_1_5), col="green")
...
Exo_temp <- ggplot(data = BVR_sensor_string, aes(x = DateTime, y = EXOTemp_C_1_5)) +
  geom_point()
Exo_temp
#ggplotly(Exo_temp)
...
MiniDotobs_5<- BVR_sensor_string%>%
  ...
  ggplot(., aes(x = DateTime, y = MiniDotObs_mgL_5)) +
  geom_point()
MiniDotobs_5
...
MiniDotsat_5<- BVR_sensor_string%>%
  filter(DateTime>"2019-10-01 00:00")%>%
  ggplot(., aes(x = DateTime, y = MiniDotSat_percent_5)) +
  geom_point()
MiniDotsat_5
...
MiniDotobs_10<- BVR_sensor_string%>%
  ...
  ggplot(., aes(x = DateTime, y = MiniDotObs_mgL_10)) +
  geom_point()
MiniDotobs_10
...
MiniDotsat_10<- BVR_sensor_string%>%
  filter(DateTime>"2018-10-01 00:00")%>%
  ggplot(., aes(x = DateTime, y = MiniDotSat_percent_10)) +
  geom_point()
MiniDotsat_10
#ggplotly(MiniDotsat_10)

#Do from the EXO
EXODO_1_5 <- BVR_sensor_string%>%
...
EXODOsat_1_5 <- BVR_sensor_string%>%
  filter(DateTime>"2019-10-01 00:00")%>%
...
plot(BVR_sensor_string$DateTime, BVR_sensor_string$EXOChla_ugL_1_5)
...
fDOM_QSU <- BVR_sensor_string%>%
  filter(DateTime>"2019-10-01 00:00")%>%
  ggplot(., aes(x = DateTime, y = EXOfDOM_QSU_1_5)) +
  geom_point()
fDOM_QSU
#ggplotly(fDOM_QSU)
...
tds <- BVR_sensor_string%>%
  filter(DateTime>"2019-10-01 00:00")%>%
  ggplot(., aes(x = DateTime, y = EXOTDS_mgL_1_5)) +
  geom_point()
tds
#ggplotly(tds)
...
BVR_sensor_string=BVR_sensor_string%>%
  mutate(
    Flag_MiniDotObs_mgL_5=ifelse(DateTime>"2019-10-18 10:19" & DateTime<"2019-10-18 11:01",2,Flag_MiniDotObs_mgL_5),
    MiniDotObs_mgL_5=ifelse(DateTime>"2019-10-18 10:19" & DateTime<"2019-10-18 11:01",NA,MiniDotObs_mgL_5),
    Flag_MiniDotSat_percent_5=ifelse(DateTime>"2019-10-18 10:19" & DateTime<"2019-10-18 11:01",2,Flag_MiniDotSat_percent_5),
    MiniDotSat_percent_5=ifelse(DateTime>"2019-10-18 10:19" & DateTime<"2019-10-18 11:01",NA,MiniDotSat_percent_5),
    Flag_MiniDotObs_mgL_5=ifelse(DateTime>"2019-11-15 9:49" & DateTime<"2019-11-15 10:21",2,Flag_MiniDotObs_mgL_5),
    MiniDotObs_mgL_5=ifelse(DateTime>"2019-11-15 9:49" & DateTime<"2019-11-15 10:21",NA,MiniDotObs_mgL_5),
    Flag_MiniDotSat_percent_5=ifelse(DateTime>"2019-11-15 9:49" & DateTime<"2019-11-15 10:21",2,Flag_MiniDotSat_percent_5),
    MiniDotSat_percent_5=ifelse(DateTime>"2019-11-15 9:49" & DateTime<"2019-11-15 10:21",NA,MiniDotSat_percent_5),
    Flag_MiniDotObs_mgL_5=ifelse(DateTime>"2019-12-06 10:39" & DateTime<"2019-12-06 11:01",2,Flag_MiniDotObs_mgL_5),
    MiniDotObs_mgL_5=ifelse(DateTime>"2019-12-06 10:39" & DateTime<"2019-12-06 11:01",NA,MiniDotObs_mgL_5),
    Flag_MiniDotSat_percent_5=ifelse(DateTime>"2019-12-06 10:39" & DateTime<"2019-12-06 11:01",2,Flag_MiniDotSat_percent_5),
    MiniDotSat_percent_5=ifelse(DateTime>"2019-12-06 10:39" & DateTime<"2019-12-06 11:01",NA,MiniDotSat_percent_5),
    Flag_MiniDotObs_mgL_5=ifelse(DateTime=="2019-12-06 10:10", 2, Flag_MiniDotObs_mgL_5),
    MiniDotObs_mgL_5=ifelse(DateTime=="2019-12-06 10:10", NA, MiniDotObs_mgL_5),
    Flag_MiniDotSat_percent_5=ifelse(DateTime=="2019-12-06 10:10", 2, Flag_MiniDotSat_percent_5),
    MiniDotSat_percent_5=ifelse(DateTime=="2019-12-06 10:10", NA, MiniDotSat_percent_5),
  )
...
BVR_sensor_string <- BVR_sensor_string %>% select(Reservoir, Site, DateTime, HoboTemp_C_0.1, HoboTemp_C_1,HoboTemp_C_2,HoboTemp_C_3,HoboTemp_C_4,
                              HoboTemp_C_5,HoboTemp_C_6,HoboTemp_C_7,HoboTemp_C_8, HoboTemp_C_9,
                              HoboTemp_C_10, HoboTemp_C_10.5,
                              MiniDotTemp_C_5,MiniDotObs_mgL_5, MiniDotSat_percent_5, 
                              MiniDotTemp_C_10,MiniDotObs_mgL_10, MiniDotSat_percent_10,
                              ...
                              EXOfDOM_RFU_1_5, EXOfDOM_QSU_1_5,EXOTurbidity_FNU_1_5, EXO_pressure_psi, EXO_depth_m, 
                              EXO_battery_V, EXO_wiper_V, 
                              ...
                              Flag_MiniDotTemp_C_5,Flag_MiniDotObs_mgL_5, Flag_MiniDotSat_percent_5, 
                              Flag_MiniDotTemp_C_10,Flag_MiniDotObs_mgL_10, Flag_MiniDotSat_percent_10,
                              Flag_EXOTemp_C_1_5, Flag_EXOCond_uScm_1_5, Flag_EXOSpCond_uScm_1_5,Flag_EXOTDS_mgL_1_5,
                              Flag_EXODOsat_percent_1_5, Flag_EXODO_mgL_1_5, Flag_EXOChla_RFU_1_5,Flag_EXOChla_ugL_1_5, 
                              Flag_EXOBGAPC_RFU_1_5,Flag_EXOBGAPC_ugL_1_5,
                              Flag_EXOfDOM_RFU_1_5,Flag_EXOfDOM_QSU_1_5, Flag_EXOTurbidity_FNU_1_5,
                              Flag_EXO_pressure_psi, Flag_EXO_depth_m, Flag_EXO_battery_V, Flag_EXO_wiper_V)
