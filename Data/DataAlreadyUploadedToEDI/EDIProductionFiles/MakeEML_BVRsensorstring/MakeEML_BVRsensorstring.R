...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_BVRsensorstring"
...
template_table_attributes(
 path = folder,
 data.path = folder,
 data.table = 'BVR_sensor_string_2016_2020.csv',
 write.file=TRUE)
...
make_eml(path = folder,
         dataset.title = "Time series of high-frequency sensor data measuring water temperature, dissolved oxygen, conductivity, specific conductance, total dissolved solids, chlorophyll a, phycocyanin, fluorescent dissolved organic matter, and turbidity at discrete depths in Beaverdam Reservoir, Virginia, USA in 2016-2020",
         data.table = 'BVR_sensor_string_2016_2020.csv',
         data.table.description = 'All water quality parameters measured at Beaverdam Reservoir during 2016-2020',
         other.entity = 'BVR_sensorstring_Collate_QAQC_2016_2020.R',
         other.entity.description = 'R script to collate sensor data, QAQC and create QAQC plots',
         temporal.coverage = c("2016-07-21", "2020-07-09"),
         ...
         user.id = "ccarey",
         user.domain = 'EDI',
         package.id = "edi.800.3") # Put your package.id here, followed by .1 (for 1st version). This is for staging
