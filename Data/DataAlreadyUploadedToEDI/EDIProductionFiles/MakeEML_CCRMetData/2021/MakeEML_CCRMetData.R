...
template_table_attributes(
 path = folder,
 data.path = folder,
 data.table = 'CCR_Met_final_2021.csv')
...
make_eml(path = folder,
         ...
         data.table = 'CCR_Met_final_2021.csv',
         data.table.name = 'CCR_Met_final_2021', 
         data.table.description = 'All meteorological parameters measured at Carvins Cove Reservoir during 2021',
         other.entity = c('QAQC_CCR_Met_2021.R', 'CCR_Met_Maintenance_2021.txt'),
         other.entity.name = c('QAQC_CCR_Met_2021', 'CCR_Met_Maintenance_2021'),
         other.entity.description = c('Data aggregation and QA/QC R script for Carvins Cove 2021','Log for maintenance done on sensors at Carvins Cove in 2021'),
         temporal.coverage = c("2021-03-29", "2021-12-31"),
         ...
         user.id = "ccarey",
         user.domain = 'EDI',
         #package.id = "edi.779.10") # Put your package.id here, followed by .1 (for 1st version), 779.1 is reserved for staged data packages 
