...
#download maintenance file. Need to make one
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data/MET_MaintenanceLog.txt", paste0(folder, "FCR_Met_Maintenance_2015_2021.txt"))
...
Met_now=read.csv(paste0(folder, "misc_data_files/ccre-met.csv"), skip = 4, header = F) 
...
RemoveMet=read.csv(folder, 'Catwalk.csv', header = T)
#str(RemoveMet)
...
lm_Panel2015=lm(Met$AirTemp_Average_C ~ Met$CR3000Panel_temp_C)
...
Met=Met%>%
  mutate(
    ...
    InfraredRadiationDown_Average_W_m2=ifelse((abs(InfraredRadiationDown_Average_W_m2-infradavg)>(2*infradsd)) & !is.na(InfraredRadiationDown_Average_W_m2),infradavg,InfraredRadiationDown_Average_W_m2))


#Old 2020 IR down for comparison
# Met_old$Flag_InfraredRadiationDown_Average_W_m2=ifelse((abs(Met$InfraredRadiationDown_Average_W_m2-Met$infradavg)<(3*Met$infradsd)),500,Met$Flag_InfraredRadiationDown_Average_W_m2)
...
# Met_old$InfraredRadiationDown_Average_W_m2=ifelse((abs(Met_old$InfraredRadiationDown_Average_W_m2-Met_old$infradavg)>(3*Met_old$infradsd)) & !is.na(Met_old$InfraredRadiationDown_Average_W_m2),Met_old$infradavg,Met_old$InfraredRadiationDown_Average_W_m2)
# Met_old$InfraredRadiationDown_Average_W_m2=ifelse(Met_old$InfraredRadiationDown_Average_W_m2<0 & !is.na(Met_old$InfraredRadiationDown_Average_W_m2), 0, Met_old$InfraredRadiationDown_Average_W_m2)


# Met_Inf_old=Met_old%>%
#   select(DateTime,InfraredRadiationDown_Average_W_m2,Flag_InfraredRadiationDown_Average_W_m2)%>%
...
Met=Met%>%
  mutate( 
    ...
    Flag_InfraredRadiationDown_Average_W_m2=ifelse(Flag_InfraredRadiationDown_Average_W_m2==2,44,Flag_InfraredRadiationDown_Average_W_m2),
    ...
    Flag_InfraredRadiationUp_Average_W_m2=ifelse(Flag_InfraredRadiationUp_Average_W_m2==2,44,Flag_InfraredRadiationUp_Average_W_m2))
...
Met$Flag_InfraredRadiationDown_Average_W_m2=as.character(Met$Flag_InfraredRadiationDown_Average_W_m2)

a=Met%>%
  filter(DateTime>"2021-12-01 00:00"& DateTime<"2021-12-31 23:59")%>%
  ggplot(., aes(x=DateTime, y=InfraredRadiationDown_Average_W_m2, color=Flag_InfraredRadiationDown_Average_W_m2))+
  geom_point()+
  geom_line(aes(x=DateTime, y=infradavg), color="black")
