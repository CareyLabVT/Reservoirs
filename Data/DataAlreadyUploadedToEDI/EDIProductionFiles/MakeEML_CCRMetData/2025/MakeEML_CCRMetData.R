...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_CCRMetData/2025/"
...
template_table_attributes(
 path = folder,
 data.path = folder,
 data.table = c('ccre-met_2021_2025.csv','ccre-met_maintenancelog_2021_2025.csv'))
...
make_eml(path = folder,
         dataset.title = "Time series of high-frequency meteorological data at Carvins Cove Reservoir, Virginia, USA 2021-2025",
         data.table = c('ccre-met_2021_2025.csv','ccre-met_maintenancelog_2021_2025.csv'),
         #data.table.name = c('CCRMet_2021_2023', 'CCRMet_maintenancelog_2021_2023'),
         data.table.description = c('All meteorological parameters measured at Carvins Cove Reservoir during 2021-2025',
                                    'Log for maintenance and outliers for the met station at Carvins Cove from 2021-2025'),
         other.entity = c('ccre-met_qaqc_2021_2025.R', 
                          'ccre-met_inspection_2021_2025.Rmd', 'Plotting_function.R'),
        # other.entity.name = c('CCRMet_qaqc_2023_2023', 
        #                       'CCRMet_inspection_2021_2023',
        #                       'Plotting_function'),
         other.entity.description = c('QAQC function used to modify and/or observations from the dataset based on the maintenance log and other outliers. Also known as the L1 function.',
                                      'Script that creates QAQC plots for visual inspection and downloads files.',
                                      'A function used to create the QAQC plots in the ccre-met_inspection_2021_2024.Rmd script.'),   
         temporal.coverage = c("2021-03-29", "2025-12-31"),
         ...
         user.domain = 'EDI',
         #STAGGING
         package.id = "edi.779.31") # Put your package.id here, followed by .1 (for 1st version), 779.1 is reserved for staged data packages 
