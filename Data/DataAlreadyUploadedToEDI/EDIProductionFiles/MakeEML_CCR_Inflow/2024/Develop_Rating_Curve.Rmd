...
res <- "CCR"
site <- 101
time_start <- as.POSIXct("2024-01-10 00:00:00", tz = "EST")
time_end <- as.POSIXct("2027-01-01 00:00:00", tz = "EST")
curve_name <- 1 #update numbering as develop new RC for each site
...
#create initial filed #Do not use-- will overwrite old rating curves; use add section below
# write.csv(selected_rating, here(
#     "Data", "DataAlreadyUploadedToEDI", "EDIProductionFiles",
#     "MakeEML_CCR_Inflow", "2024", "Rating_Curves.csv"), row.names = F)
