...
#   rbind(ccr_met_git)
#add more recent met data
met_new <- read_csv("https://raw.githubusercontent.com/FLARE-forecast/CCRE-data/refs/heads/ccre-dam-data-qaqc/ccre_met_L1.csv")

ccr_met_comb <- bind_rows(ccr_met_edi, met_new) 

ccr_met <- ccr_met_comb |> 
...
rain_comp <- left_join(stage_final, ccr_met_comb, by = "DateTime")
