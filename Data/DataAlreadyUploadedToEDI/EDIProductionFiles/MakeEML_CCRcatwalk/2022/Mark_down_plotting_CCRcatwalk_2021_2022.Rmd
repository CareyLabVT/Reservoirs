...
#Depth from the 1m EXO
 Depth_1 <- ggplot(data = ccrwater2, aes(x = DateTime, y = EXODepth_m_1)) +
   geom_point()
 Depth_1
#Only use plotly to find DateTime of questionable values
# ggplotly(Depth_1)
...
#Just the current year
 Depth_1_21=ccrwater2%>%
  filter(DateTime>current_time_start & DateTime<current_time_end)%>%
  ggplot(.,aes(x = DateTime, y = EXODepth_m_1)) +
   geom_point()
 Depth_1_21
#Only use plotly to find DateTime of questionable values
# ggplotly(Depth_1_21)
...
```{r EXO depth 9m}
 ...
 Depth_9 <- ggplot(data = ccrwater2, aes(x = DateTime, y = EXODepth_m_9)) +
   geom_point()
 Depth_9
 #Only use plotly to find DateTime of questionable values
 # ggplotly(Depth_9)
 ...
 Depth_9_21=ccrwater2%>%
   filter(DateTime>current_time_start & DateTime<current_time_end)%>%
   ggplot(.,aes(x = DateTime, y = EXODepth_m_9)) +
   geom_point()
 Depth_9_21
 #Only use plotly to find DateTime of questionable values
 # ggplotly(Depth_9_21)
