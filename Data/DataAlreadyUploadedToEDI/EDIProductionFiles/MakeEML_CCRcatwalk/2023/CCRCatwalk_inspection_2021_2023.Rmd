...
# Read in the current L1 file from GitHub
...
# make the plots
outputs <- lapply(dx, all_plot,y_lab = "Meters", y_lab2 = "Meters", Water= T, Raw_file=T, Use_plotly=T)
...
# make the plots
outputs <- lapply(dx, all_plot,y_lab = "mg/L or % sat", y_lab2 = "mg/L or % sat", Water= T, Raw_file=T, Use_plotly=T)
...
# qaqc function
download.file("https://raw.githubusercontent.com/FLARE-forecast/CCRE-data/ccre-dam-data-qaqc/R/edi_qaqc_function.R", "CCRCatwalk_qaqc_2023_2023.R")
