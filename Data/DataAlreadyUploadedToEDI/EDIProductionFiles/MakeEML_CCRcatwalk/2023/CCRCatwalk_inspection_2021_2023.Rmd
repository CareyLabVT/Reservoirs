...
L1 <- qaqc_ccr(
          ...
          data2_file = 
         output_file = NULL, 
         start_date = force_tz(as.POSIXct(), tzone = "EST"), 
         end_date = Sys.Date())
...
# qaqc function
download.file("https://raw.githubusercontent.com/FLARE-forecast/CCRE-data/ccre-dam-data-qaqc/R/edi_qaqc_function.R", "CCRCatwalk_qaqc_2023.R")
