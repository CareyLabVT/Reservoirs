...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_CCRcatwalk/2023/"
...
make_eml(path = folder,
         ...
         data.table = c("CCRCatwalk_2021_2023.csv","CCR_hobos_2020_2021.csv","CCR_Depth_offsets_2021_2023.csv",  
                        "CCRCatwalk_maintenancelog_2021_2023.csv", "reservoir_site_descriptions.csv"),
         data.table.name = c("CCRCatwalk_2021_2023","CCR_hobos_2020_2021","CCR_Depth_offsets_2021_2023",  
                             "CCRCatwalk_maintenancelog_2021_2023", "reservoir_site_descriptions"),
         data.table.description = c("CCR Catwalk data for 2021 to 2023",
                                    "CCR HOBO Temperature String 2020-2021",
                                    "CCR offsets for sensor depths", 
                                    "CCR sensor maintenace log for waterquality sensors", 
                                    "Sampling site descriptions"),
         other.entity = c('CCRCatwalk_qaqc_2023_2023.R', 
                          'CCRCatwalk_inspection_2021_2023.Rmd', 
                          'find_depths.R', 
                          'Plot_function.R',
                          "CCR_hobo_compilation_2020_2021.R"),
         other.entity.name = c('CCRCatwalk_qaqc_2023_2023', 
         ...
         user.id =  "ccarey",
         package.id = "edi.719.23", #### this is the one that I need to change and the one for staging!!! 719.9 was the last stagging id for 2021 publishing
