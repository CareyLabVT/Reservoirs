...
make_eml(path = folder,
         ...
         data.table = c("CCRCatwalk_2021_2023.csv","CCRCatwalk_maintenancelog_2021_2023.csv","CCRCatwalk_Depth_offsets_2021_2023.csv",  
                        "CCR_hobos_2020_2021.csv", "reservoir_site_descriptions.csv"),
        ...
        #                      'CCR_hobo_compilation_2020_2021'),
         ...
         user.id =  "ccarey",
         #package.id = "edi.719.26", #### this is the one that I need to change and the one for staging!!! 719.9 was the last stagging id for 2021 publishing
         package.id = "edi.1069.2", #### THIS IS USED FOR PUBLISHING
         user.domain = 'EDI')
