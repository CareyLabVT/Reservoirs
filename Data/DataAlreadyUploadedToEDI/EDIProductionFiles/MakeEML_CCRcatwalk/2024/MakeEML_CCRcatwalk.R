...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_CCRcatwalk/2024/"
...
template_table_attributes(path = folder,
                          data.path = folder,
                          data.table = c("ccre-waterquality_2021_2024.csv", "ccre-waterquality_depth_offsets_2021_2024.csv",
                                         "ccre-waterquality_hobos_2020_2021.csv", "ccre-waterquality_maintenancelog_2021_2024.csv", 
...
make_eml(path = folder,
         ...
         total dissolved solids, chlorophyll a, phycocyanin, and fluorescent dissolved organic matter at discrete depths in Carvins Cove Reservoir, Virginia, USA in 2020-2024",
         data.table = c("ccre-waterquality_2021_2024.csv","ccre-waterquality_maintenancelog_2021_2024.csv","ccre-waterquality_depth_offsets_2021_2024.csv",  
         ...
         data.table.description = c("ccre-waterquality data at CCR for sensors off the dam for 2021 to 2024",
         ...
         other.entity = c('ccre-waterquality_qaqc_2021_2024.R', 
                          'ccre-waterquality_inspection_2021_2024.Rmd', 
                          'find_depths.R', 
                          'Plotting_function.R',
        ...
        #                      'ccre-waterhobo_compilation_2020_2021'),
         ...
         temporal.coverage = c("2020-07-29", "2024-12-31"),
         ...
         user.id =  "ccarey",
        # package.id = "edi.719.30", #### this is the one that I need to change and the one for staging!!! 719.9 was the last stagging id for 2021 publishing
