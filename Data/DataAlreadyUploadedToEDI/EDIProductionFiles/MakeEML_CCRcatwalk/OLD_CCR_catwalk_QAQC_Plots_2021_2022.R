...
source(paste0(folder, "CCR_catwalk_QAQC_function_2021_2022.R"))
...
download.file("https://raw.githubusercontent.com/FLARE-forecast/CCRE-data/ccre-dam-data/CCRW_maintenance_log.txt",paste0(folder, "CCRW_maintenance_log_2021_2022.txt"))
download.file("https://raw.githubusercontent.com/FLARE-forecast/CCRE-data/ccre-dam-data/ccre-waterquality.csv",paste0(folder, "misc_data_files/ccre-waterquality.csv"))
...
data_file <- paste0(folder, "misc_data_files/ccre-waterquality.csv")#current file from the data logger
#data2_file <- paste0(folder, 'misc_data_files/CAT_2.csv')#manual downloads to add missing data 
maintenance_file <- paste0(folder, "CCRW_maintenance_log_2021_2022.txt")#maintenance file
output_file <- paste0(folder, "misc_data_files/CCRwaterquality_first_QAQC_2021_2022.csv")#name of the output file
qaqc_ccr(data_file, maintenance_file, output_file)#function to do the main qaqc


# read in qaqc function output

ccrwater <- read.csv(paste0(folder, "misc_data_files/CCRwaterquality_first_QAQC_2021_2022.csv"))

#current time of QAQC for graphing
current_time_start="2022-01-01 00:00"
current_time_end="2022-12-31 23:59"
