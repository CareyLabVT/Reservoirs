...
template_core_metadata(path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
                       license = "CCBY",
                       file.type = ".txt",
                       write.file = TRUE)

template_table_attributes(path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
                          data.path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
                          data.table = c("EDI_DATA_EBU_DIFF_DEPTH.csv",
                                         "EDI_DATA_HOBO_TEMPS_2017.csv",
                                         "EDI_DATA_TURB_2017.csv",
                                         "SITE_LOCATIONS_EBU.csv"),
                          write.file = TRUE)


#we want empty to be true for this because we don't include lat/long
#as columns within our dataset but would like to provide them
template_geographic_coverage(path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
                             data.path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
                             data.table = c("EDI_DATA_EBU_DIFF_DEPTH.csv",
                                            "EDI_DATA_HOBO_TEMPS_2017.csv",
                                            "EDI_DATA_TURB_2017.csv",
...
template_categorical_variables(path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
                               data.path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
                               write.file = TRUE)
...
make_eml(
  path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
  data.path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
  eml.path = "C:/Users/Owner/Dropbox/EDI_DATA_PROCESSING/MakeEML_EbuMission17",
  dataset.title = "Methane ebullition and diffusion rates, turbulence, water temperature, and water depth data from Falling Creek Reservoir (Virginia, USA) in the ice-free period during 2016-2019",
  temporal.coverage = c("2016-03-28", "2019-11-07"),
  geographic.description = "Southwestern Virginia, USA, North America",
  geographic.coordinates = c('37.309589','-79.836009','37.302660','-79.839249'),
  maintenance.description = 'ongoing',
  data.table.description = c("Ebullition, diffusion, and depth data from 24 sites in Falling Creek Reservoir", 
                             "Sediment and surface water temperatures data from Falling Creek Reservoir in 2017, 2018, and 2019",
                             "Sediment and surface water turbulence from four transects in Falling Creek Reservoir in 2017",
                             "Location of the 24 sites in Falling Creek Reservoir"),
  data.table.name = c("Methane Emissions","Temperature", "2017 Turbulence", "Site Locations"),
  data.table = c("EDI_DATA_EBU_DIFF_DEPTH.csv",
                 "EDI_DATA_HOBO_TEMPS_2017_2019.csv",
                 "EDI_DATA_TURB_2017.csv",
                 "SITE_LOCATIONS_EBU.csv"),
  user.id = 'ryanmclake',
  user.domain = 'EDI',
  package.id = 'edi.440.2')
