...
# Make a DateTime column but remove it before saving the file
 current_df$DateTime <- ymd_hms(paste0(current_df$date, " " ,current_df$time), tz="America/New_York")
...
# MAKE SURE TO UPDATE THE PASTA FROM THE VERSION YOU WANT
                                                                ...
                                                                ### CHANGE THIS NUMBER BELOW 
                                                                             ##      
 # current_df <-read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/157/29/6b78ab905a142b5dcc29044b83bae676")
 # 
...
dups <- dups%>%
  select(date, time, co2_flux_umolm2s,  specific_humidity_kgkg, u_star_ms) 
