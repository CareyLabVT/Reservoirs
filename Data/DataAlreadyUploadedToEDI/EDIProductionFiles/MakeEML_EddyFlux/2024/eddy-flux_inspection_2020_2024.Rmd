...
```{r QAQC raw files, include=FALSE}
...
For the plots, they use a function called "all_plot". In all_plot you can specify if you want plotly plots for the current data. If you run this script chunk by chunk, the current year plots using plotly will NOT be generated. To see the plots, uncomment the code and then output[[1]]. For right now you can specify which plotly plots you want on. You can also look at the plotly plots manually in each chunk by running the chunk with Use_plotly=TRUE as an argument and then at the end of the chunk output[[1]]. 
...
write_csv(current_df2, "EddyFlux_2020_2024.csv")
...
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Scripts/L1_functions/eddy_flux_create.R", "EddyFlux_qaqc_2020_2024.R")
...
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/EddyFlux_Processing/FCR_Process_BD_Markdown.Rmd", "EddyFlux_processing_2020_2024.Rmd")
