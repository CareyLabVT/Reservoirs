...
current_df <-read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/692/30/9686456c091a205d2444fb01342eeedc")
...
dx <- colnames(current_df%>%select(co2_flux_umolm2s, h2o_flux_umolm2s, ch4_flux_umolm2s, rssi_77_mean))
...
```{r Make new CSV with current and historic files, echo=FALSE}
