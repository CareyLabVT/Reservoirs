...
Met_now=read.csv("./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_FCRMetData/2021/misc_data_files/FCRmet.csv", skip = 4, header = F) 
...
RemoveMet=read.csv("./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_FCRMetData/2021/FCR_Met_Maintenance_2015_2021.txt", header = T)
#str(RemoveMet)
