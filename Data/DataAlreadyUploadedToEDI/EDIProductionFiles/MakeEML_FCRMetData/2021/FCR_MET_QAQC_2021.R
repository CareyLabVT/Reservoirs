...
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data/MET_MaintenanceLog.txt", paste0(folder, "MET_MaintenanceLog.txt"))
...
Met=Met%>%
  mutate(
    Flag_PAR_Total_mmol_m2=ifelse(during_day==FALSE & PAR_Total_mmol_m2>1, 4, Flag_PAR_Total_mmol_m2),
    Note_PAR_Total_mmol_m2=ifelse(during_day==FALSE & PAR_Total_mmol_m2>1, "Outlier_set_to_NA", Note_PAR_Total_mmol_m2),
    PAR_Total_mmol_m2=ifelse(during_day==FALSE & PAR_Total_mmol_m2>1, NA, PAR_Total_mmol_m2))
...
Met=Met%>%
  mutate(
    Flag_PAR_Average_umol_s_m2=ifelse(DateTime>"2021-05-01 00:00:00"&DateTime<"2021-07-01 23:59:00"& PAR_Average_umol_s_m2>2500, 5, Flag_PAR_Average_umol_s_m2),
    Note_PAR_Average_umol_s_m2=ifelse(DateTime>"2021-05-01 00:00:00"&DateTime<"2021-07-01 23:59:00"& PAR_Average_umol_s_m2>2500, "Questionable_value", Note_PAR_Average_umol_s_m2),
  Flag_PAR_Total_mmol_m2=ifelse(DateTime>"2021-05-01 00:00:00"&DateTime<"2021-07-01 23:59:00"& PAR_Average_umol_s_m2>2500, 5, Flag_PAR_Total_mmol_m2),
...
Met=Met%>%
  mutate(
    Flag_InfaredRadiationDown_Average_W_m2=ifelse(DateTime>"2021-08-30 00:00:00" & DateTime<"2021-10-03 23:59:00",4,Flag_InfaredRadiationDown_Average_W_m2),
    Note_InfaredRadiationDown_Average_W_m2=ifelse(DateTime>"2021-08-30 00:00:00" & DateTime<"2021-10-03 23:59:00","outlier_set_to_NA_due_to_probable_sensor_failure",Note_InfaredRadiationDown_Average_W_m2),
    InfaredRadiationDown_Average_W_m2=ifelse(DateTime>"2020-08-31 00:00:00" & DateTime<"2021-10-03 23:59:00",NA,InfaredRadiationDown_Average_W_m2))

Met=Met%>%
  mutate(
    Flag_InfaredRadiationDown_Average_W_m2=ifelse(DateTime>"2021-11-21 00:00:00"&DateTime<"2021-12-01 23:59:00",4,Flag_InfaredRadiationDown_Average_W_m2),
    Note_InfaredRadiationDown_Average_W_m2=ifelse(DateTime>"2021-11-21 00:00:00"&DateTime<"2021-12-01 23:59:00","outlier_set_to_NA_due_to_probable_sensor_failure",Note_InfaredRadiationDown_Average_W_m2),
    InfaredRadiationDown_Average_W_m2=ifelse(DateTime>"2021-11-21 00:00:00"&DateTime<"2021-12-01 23:59:00",NA,InfaredRadiationDown_Average_W_m2))
...
#PAR
PAR_Avg=Met%>%
  filter(DateTime>"2021-05-15 00:00:00" & DateTime<"2021-05-19 23:59")
...
InfRad_Dn=Met%>%
  filter(DateTime>"2021-11-15 00:00")
  ggplot(.,aes(x=DateTime, y=InfaredRadiationDown_Average_W_m2, col=InfaredRadiationDown_Average_W_m2))+
  geom_point()
...
write.csv(Met_final, "FCR_Met_final_2015_2021.csv", row.names=F, quote=F)
write.csv(RemoveMet, "FCR_Met_Maintenance_2015_2021.csv", row.names=F, quote = F)
