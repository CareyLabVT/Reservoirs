...
pacman::p_load("RCurl","tidyverse","lubridate", "plotly", "magrittr", "suncalc", "dplyr")
...
RemoveMet=read.csv("./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_FCRMetData/2022/FCR_Met_Maintenance_2015_2022.txt", header = T)
#str(RemoveMet)
