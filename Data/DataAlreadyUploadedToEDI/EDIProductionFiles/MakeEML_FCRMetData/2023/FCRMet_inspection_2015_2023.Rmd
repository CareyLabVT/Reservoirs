...
```{r Read in Historical EDI Files, include=FALSE}
...
# Use the qaqc script to get the qaqc file for the current year with notes. We turn this off when we make the L1 file for GitHub because it adds a lot of bytes. 
L1 <- qaqc_fcrmet(
         output_file = NULL, 
...
# Not need to set the time because Done in the qaqc_fcrmet function
...
# qaqc function
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data-qaqc/R/edi_qaqc_function.R", "FCRMet_qaqc_2023_2023.R")
