...
make_eml(path = folder,
        ...
        # data.table.name = c('FCRMet_2015_2023','FCRMet_maintenancelog_2015_2023', 'FCRMet_Infrad_DOY_Avg_2015_2017'),
         data.table.description = c('All meteorological parameters measured at Falling Creek Reservoir during 2015-2024.',
                            'The log for all maintenance and outliers for the Falling Creek Reservoir meteorology station that go into the QAQC script for 2015-2024.',
         ...
         other.entity.description = c('Script used to flag, modify, and/or remove observations from the dataset based on the maintenance log and other outliers. Also known as the L1 function. This script was used on all observations from 2015-2024.',
