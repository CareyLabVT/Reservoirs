...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_FCRMetData/2024"
...
template_table_attributes(
 path = folder,
 data.path = folder,
 data.table = c('fcre-met_2015_2024.csv', "fcre-met_maintenancelog_2015_2024.csv", "fcre-met_Infrad_DOY_Avg_2015_2017.csv"))
...
template_geographic_coverage(path = folder,
                             data.path = folder,
                             data.table = 'fcre-met_2015_2024.csv',
                             empty = TRUE,
                             write.file = TRUE)
...
make_eml(path = folder,
         data.path = folder,
         eml.path = folder,
         dataset.title = "Time series of high-frequency meteorological data at Falling Creek Reservoir, Virginia, USA 2015-2024",
         data.table = c('fcre-met_2015_2024.csv','fcre-met_maintenancelog_2015_2024.csv', 'fcre-met_Infrad_DOY_Avg_2015_2017.csv'),
        # data.table.name = c('FCRMet_2015_2023','FCRMet_maintenancelog_2015_2023', 'FCRMet_Infrad_DOY_Avg_2015_2017'),
         data.table.description = c('All meteorological parameters measured at Falling Creek Reservoir during 2015-2024',
                            'The log for all maintenance and outliers for the Met station that go into the QAQC script for 2015-2024',
                            'Infrared average and standard deviation for day of year from 2015-2017. The file is used in fcre-met_qaqc_2015_2024 in the met_infrad argument.'),
         other.entity = c('fcre-met_qaqc_2015_2024.R', 'fcre-met_inspection_2015_2024.Rmd', 'Plotting_function.R'),
         #other.entity.name = c('FCRMet_qaqc_2015_2023', 'FCRMet_inspection_2015_2023', 'Plotting_function'),
         other.entity.description = c('Script used to take out observations from the dataset based on the maintenance log and other outliers. Also known as the L1 function. This script was used on all observations from 2015-2024.',
                                      'Inspection script creates QAQC plots and downloads the necessary files for publication.',
                                      'A function used to create the QAQC plots in the fcre-met_inspection_2015_2024.Rmd script'),
         temporal.coverage = c("2015-07-07", "2024-12-31"),
         ...
         user.id = "ccarey",
         user.domain = 'EDI',
         package.id = "edi.143.30") # FOR STAGING ENVIORNMENT THE PACKAGE ID IS "edi.143.#"
