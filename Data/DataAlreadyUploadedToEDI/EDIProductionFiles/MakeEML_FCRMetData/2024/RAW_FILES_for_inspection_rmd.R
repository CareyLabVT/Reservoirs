...
ds <- c(
  ...
  'https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/refs/heads/fcre-metstation-data-qaqc/FCRmet_legacy_2023.csv',
...
man_files <- c(
  ...
  'https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/MetStation/FCRMet_ManualDownloads_2024.csv'
)
...
state_met <- tibble(data_file = ds,
                    ...
                    maintenance_file = rep('https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data-qaqc/MET_maintenancelog_new.csv',each=9),
                    met_infrad = rep('https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data-qaqc/FCR_Met_Infrad_DOY_Avg_2018.csv', each=9),
                    output_file = I(list(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)),
                    start_date = I(list(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)),
                    end_date = I(list(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)),
                    notes = rep(TRUE, each=9))
