...
source("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data-qaqc/R/edi_qaqc_function.R")
...
file_name <- "fcre-met_2015_2025.csv"

qaqc_function <- "fcre-met_qaqc_2015_2025.R"

maintenance_log <- "fcre-met_maintenancelog_2015_2025.csv"
...
# List of the streaming raw data files from the Gateway. Since they are so large we have to make raw files for each year. Then add in the manual download files too. 
...
ds <- c(
  ...
  'https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/refs/heads/fcre-metstation-data-qaqc/FCRmet_legacy_2024.csv',
  
  # THE CURRENT YEARS FILE
  'https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data/FCRmet.csv',

# The manual downloaded files start here:
  ...
  'https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/refs/heads/master/MetStation/FCRMet_ManualDownloads_2025.csv'
)

# QAQC the data frame using the list of files above

current_df <- qaqc_fcrmet(data_file = ds,
...
catwalk <- current_df
 ...
 print("Note if there are no data here then there are no daily gaps")
```
...
print("Note, if there are no data here, then there are no missing observations for the current year.")
...
Let's look at the flag Frequency for each variable. Make sure there are 0s under the NA for each Flag column. We want to make sure
every observation has a flag. 
...
```{r Print plotly temp, echo=FALSE, warning=FALSE, messages=FALSE}
...
#### Relative Humidity, Wind Speed, and Wind Direction Plots
...
## Run this right before you are ready to stage the data. You will have to re-run this section if you change the maintenace log or the qaqc script. 

# Maintenance Log
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data-qaqc/MET_maintenancelog_new.csv", maintenance_log)

# qaqc function
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data-qaqc/R/edi_qaqc_function.R", qaqc_function)
...
# Infrad_DOY_average
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-metstation-data-qaqc/FCR_Met_Infrad_DOY_Avg_2018.csv", "fcre-met_Infrad_DOY_Avg_2015_2017.csv")
