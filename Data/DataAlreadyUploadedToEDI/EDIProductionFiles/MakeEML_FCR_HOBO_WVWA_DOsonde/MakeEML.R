...
folder <- paste0(getwd(), "/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_FCR_HOBO_WVWA_DOsonde")
folder
...
make_eml(path = folder,
         ...
         user.id =  "ccarey",
         package.id = "edi.1005.2", #### this is the one that I need to change and the one for staging!!!
         user.domain = 'EDI')
