...
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-catwalk-data/CAT_MaintenanceLog.txt", "FCR_CAT_MaintenanceLog_2018_2022.txt")
...
data_file <-'misc_data_files/fcre-waterquality.csv'
#manual downloads to add missing data 
data2_file <-'misc_data_files/CAT_2.csv'
#maintenance file
maintenance_file <- "FCR_CAT_MaintenanceLog_2018_2022.txt"
#name of the output file
output_file <-"misc_data_files/Catwalk_first_QAQC_2018_2022.csv"
...
# #Just the current year
 m_1_21=catdata%>%
  filter(DateTime>ymd_hms(ymd_hms(ymd_hms(current_time_start))) & DateTime<ymd_hms(ymd_hms(ymd_hms(current_time_end))))%>%
...
```{r All Temperature}
 ...
 All_temp_fcr=catdata%>%
    ...
    geom_line(aes(y=ThermistorTemp_C_10, color="9m"))+
...
Depth_press_sensor_current <- catdata%>%
  filter(DateTime>ymd_hms(current_time_start) & DateTime<ymd_hms(current_time_end))%>%
  ggplot(data = catdata, aes(x = DateTime, y = LvlDepth_m_9)) +
      geom_point()
...
#Depth from the 1m EXO
 Depth_1 <- ggplot(data = catdata, aes(x = DateTime, y = EXO_depth_m_1)) +
   geom_line()
 Depth_1
#Only use plotly to find DateTime of questionable values
# ggplotly(Depth_1)
...
[34] "EXOfDOM_QSU_1"                 "EXOTurbidity_FNU_1"            "EXO_pressure_psi"             
[37] "EXO_depth_m"                   "EXO_battery_V"                 "EXO_cablepower_V"             
[40] "EXO_wiper_V"                   "Lvl_psi_9"                     "LvlTemp_C_9"                  
...
[70] "Flag_EXOfDOM_QSU_1"            "Flag_EXOTurbidity_FNU_1"       "Flag_EXO_pressure_psi"        
[73] "Flag_EXO_depth_m"              "Flag_EXO_battery_V"            "Flag_EXO_cablepower_V"        
[76] "Flag_EXO_wiper_V"              "Flag_Lvl_psi_9"                "Flag_LvlTemp_C_9"             
...
#rearrange the cols. They should already be in order but just making sure. 
 catdata_flag <- catdata_flag %>%
  select(Reservoir, Site, DateTime, ThermistorTemp_C_surface:ThermistorTemp_C_9,
         ...
         EXOfDOM_RFU_1, EXOfDOM_QSU_1,EXOTurbidity_FNU_1, EXO_pressure_psi, EXO_depth_m, EXO_battery_V,          EXO_cablepower_V,EXO_wiper_V, Lvl_psi_9, LvlTemp_C_9, Depth_m_9, RECORD, CR6_Batt_V,          CR6Panel_Temp_C,Flag_ThermistorTemp_C_surface:Flag_ThermistorTemp_C_9,Flag_RDO_mgL_5, Flag_RDOsat_percent_5, Flag_RDOTemp_C_5,
