...
folder <- paste0(getwd(), "/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_FCRcatwalk/2024")
folder
...
template_table_attributes(path = folder,
                          data.path = folder,
                          data.table = c("fcre-waterquality_2018_2024.csv",
                                         "fcre-waterquality_maintenancelog_2018_2024.csv"),
                          write.file = TRUE)
...
make_eml(path = folder,
         ...
         in Falling Creek Reservoir, Virginia, USA in 2018-2024",
         data.table = c("fcre-waterquality_2018_2024.csv", 
                        'fcre-waterquality_maintenancelog_2018_2024.csv'),
         ...
         other.entity = c('fcre-waterquality_qaqc_2018_2024.R', 
                          'fcre-waterquality_inspection_2018_2024.Rmd',
                          'Plotting_function.R'),
         ...
         temporal.coverage = c("2018-07-05", "2024-12-31"),
         ...
         user.id =  "ccarey",
         package.id = "edi.518.32", #### this is the one that I need to change and the one for staging!!!
