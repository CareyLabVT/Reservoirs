...
edi_link <-"https://pasta-s.lternet.edu/package/data/eml/edi/518/30/f23d27b67f71c25cb8e6232af739f986"
...
state_cat <- tibble(data_file = ds,
                    ...
                    maintenance_file = rep('https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/refs/heads/fcre-catwalk-data-qaqc/FCR_CAT_MaintenanceLog.csv',each=3),
                    output_file = I(list(NULL, NULL, NULL)),
                    start_date = c(ymd_hms("2018-07-05 14:45:00", tz="EST"), ymd_hms("2023-12-31 23:59:00", tz="EST"), ymd_hms("2024-12-31 23:59:00", tz="EST")),
                    end_date = c(ymd_hms("2023-12-31 23:59:00", tz="EST"), ymd_hms("2024-12-31 23:59:00", tz="EST"), Sys.Date() + lubridate::days(1)),
                    dir = rep(here::here(), each = 3))
