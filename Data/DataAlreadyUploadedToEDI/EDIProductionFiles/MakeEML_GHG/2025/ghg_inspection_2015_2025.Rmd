...
pacman::p_load(tidyverse, lubridate, gsheet, readxl, plotly, htmltools)
...
tagList(lapply(outputs[[1]], ggplotly))
        tagList(lapply(outputs[[2]], ggplotly))
...
```{r All CCR Site 50 Plots All data, echo=FALSE}
