...
make_eml(
  ...
  data.table = c('GHG_2015_2023.csv','site_descriptions.csv', "GHG_Maintenance_Log.csv" ),
  ...
  data.table.name = c("GHG_2015_2023","site_descriptions", "GHG_Maintenance_Log"),
  other.entity= c('GHG_qaqc_2023_2023.R', 'GHG_functions_for_L1.R',
                  'GHG_inspection_2015_2023.Rmd'),
  other.entity.name = c("GHG_qaqc_2023_2023", 'GHG_functions_for_L1',
