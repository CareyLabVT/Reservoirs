...
# load data package
pacman::p_load(devtools, EMLassemblyline, here, XML, xml2)

folder <- paste0(here(),"/Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_Inflow/2026_Jan/")
...
template_table_attributes(path = folder,
                          data.path = folder,
                          data.table = c("fcre-inflow_2013_2025.csv", "fcre-inflow_maintenancelog_2013_2025.csv",
                                         "fcre-inflow_gaugeheight_2019_2025.csv", "fcre-inflow_ratingcurve_2013_2025.csv"),
                          write.file = TRUE)
...
eml_file <-make_eml(
  ...
  data.path = folder,
  eml.path = folder,
  dataset.title = "Discharge time series for the primary inflow tributary entering Falling Creek Reservoir, Vinton, Virginia, USA 2013-2025",
  data.table = c("fcre-inflow_2013_2025.csv", "fcre-inflow_maintenancelog_2013_2025.csv",
                 "fcre-inflow_gaugeheight_2019_2025.csv", "fcre-inflow_ratingcurve_2013_2025.csv"),
  #data.table.name = c("Inflow_2013_2022.csv", "Inflow_Maintenance_RatingCurveLog_2013_2022"), 
  data.table.description = c("FCR inflow dataset from 2013 to 2025",
  ...
  other.entity = c("fcre-inflow_qaqc_2013_2025.R","fcre-inflow_inspection_2013_2025.Rmd", 'Plotting_function.R'),
  ...
  temporal.coverage = c("2013-05-15", "2025-12-31"),
  maintenance.description = 'ongoing',
  user.id = 'ccarey',
  user.domain = 'EDI',
   package.id = 'edi.923.25', # USed for staging the data package 
