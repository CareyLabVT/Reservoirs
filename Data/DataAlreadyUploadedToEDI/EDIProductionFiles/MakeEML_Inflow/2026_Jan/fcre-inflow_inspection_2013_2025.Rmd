...
If you are REVIEWING this data package, update the role and the pasta URL from EDI in the "EDI HERE" chunk and then knit the file together. 
...
file_name <- "fcre-inflow_2013_2025.csv"

qaqc_function <- "fcre-inflow_qaqc_2013_2025.R"

maintenance_log <- "fcre-inflow_maintenancelog_2013_2025.csv"

gauge_height <- "fcre-inflow_gaugeheight_2019_2025.csv"
...
ds <- c('https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-weir-data/FCRweir.csv', 
        'https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/refs/heads/fcre-weir-data-qaqc/FCRweir_legacy_2019_2020_2021_2022_2023_2024.csv',
        
        # manual download
        'https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/WeirData/WeirData_2019_2024.csv'
        )


# Water Authority files

WVWA <- c('https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/Raw_inflow/WVWA_weirInflow_2013_2024.csv','https://raw.githubusercontent.com/CareyLabVT/Reservoirs/refs/heads/master/Data/DataNotYetUploadedToEDI/Raw_inflow/WVWA_weirInflow_L1.csv')
...
output_file = NULL,
output_file_rating_curve = "fcre-inflow_ratingcurve_2013_2025.csv",
start_date = NULL,
end_date = NULL)
...
weirdata%>%
  filter(DateTime>current_time_start & DateTime<current_time_end)%>%
  drop_na(VT_Flow_cms)%>%
  ggplot(.,aes(x=WVWA_Flow_cms, y=VT_Flow_cms, color=as.factor(month(DateTime))))+
  geom_point()+
  #stat_smooth(method = "lm", col = "red")+
  # ggpubr::stat_regline_equation(
  #   aes(label =  paste(..eq.label.., ..adj.rr.label.., sep = "~~~~"))
  # )+
  ggtitle("Compare WVWA flow and VT flow for the current year") 
...
# Maintenance Log
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-weir-data-qaqc/Weir_MaintenanceLog.csv", maintenance_log)

# Gauge Height
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-weir-data-qaqc/Inflow_Gauge_Height_at_Weir.csv",gauge_height)

height <- read_csv(gauge_height)

write.csv(height, gauge_height, row.names = F)

# qaqc function
download.file("https://raw.githubusercontent.com/FLARE-forecast/FCRE-data/fcre-weir-data-qaqc/R/qaqc_function.R", qaqc_function)
