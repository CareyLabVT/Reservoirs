...
eml_file <- make_eml(path = folder,
         ...
         #package.id = "edi.1017.23", #### this is the one that I need to change!!! For the staging environment
         package.id = "edi.454.9", #### this is the one that I need to change!!! For the production environment
         user.domain = 'EDI',
