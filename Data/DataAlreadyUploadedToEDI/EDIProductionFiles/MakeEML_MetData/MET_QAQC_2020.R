...
###Last modified 7 FEB 2020 to publish 2015-2019 met data to EDI
...
#past MET data from the EDI website had to read in from download from EDI website
Met_past=read.csv("Met_final_2015_2019.csv")
...
#Set end date
Met_now=Met_now[year(Met_now$TIMESTAMP)<2021,]

####3) Aggregate data set for QA/QC ####
Met= Met_now #reset data so you don't have to load from scratch 
...
MetAir_2015=Met_past[Met_past$DateTime<"2016-01-01 00:00:00",c(3,6,10)]
...
#only need to do this for data from 2015 to  2016-07-25 10:55:00
...
Met_past$DOY=yday(Met_past$DateTime)
Met_infrad=Met_past[year(Met_past$DateTime)<2018,]
...
Met_infrad=unique(Met_infrad[,c(46,47,48)])
...
#add in the past data now and then check for flags
#remove the YDO from the Met_past
Met_past=Met_past[,-(46)]
  

Met_agg<-rbind(Met_past,Met) #binds past and current data from Met station
