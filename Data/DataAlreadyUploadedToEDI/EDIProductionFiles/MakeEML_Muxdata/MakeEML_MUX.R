...
folder <- "./Data/DataAlreadyUploadedToEDI/EDIProductionFiles/MakeEML_Muxdata/"
...
make_eml(
  ...
  data.table = c("MUX_FP_TS.csv", 
                 "MUX_predictions_boot.csv"),
  data.table.name = c("MUX_FP_TS", 
                      "MUX_predictions_boot"),
  ...
  other.entity.name = c("1_Overlaps_MUX","2_PLSR_MUX_bootstrap", "PLSR_MUX_functions"),
  ...
  user.id = 'mschreib',
  user.domain = 'EDI',
  #package.id = 'edi.974.7') #THIS IS THWE EDI PACKAGE NUMBER FOR STAGING
  package.id = 'edi.1360.1') #USE THIS FOR FINAL PRODUCTION
