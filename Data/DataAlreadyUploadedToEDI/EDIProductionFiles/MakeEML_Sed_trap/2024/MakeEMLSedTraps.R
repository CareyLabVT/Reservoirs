##MakeEMLSed traps
##Based on a file written by Mary Lofton - thanks, Mary!
##Modified by Abby and Cece
...
make_eml(
  ...
  #                       "Metals Visual Inspection Script"),
  ...
  user.id = 'mschreib',
  user.domain = 'EDI',
  package.id = 'edi.1474.6') #reserve new staging environment package id each year
