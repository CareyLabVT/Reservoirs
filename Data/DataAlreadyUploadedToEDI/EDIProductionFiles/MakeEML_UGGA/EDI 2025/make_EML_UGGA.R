...
template_table_attributes(path = folder,
                          data.path = folder,
                          data.table = c("ugga_2018_2025.csv", "ugga_maintenancelog_2018_2025.csv"),
                          write.file = TRUE)
...
make_eml(path = folder,
         ...
         data.table = c("ugga_2018_2025.csv",
                        "site_descriptions.csv",
                        "ugga_maintenancelog_2018_2025.csv"),
         #data.table.name = c("UGGA dataset 2018-2025",
     #                        "Sample site descriptions"),
         ...
         other.entity = c(#'RawData.zip', 
                          "ugga_inspection_2018_2025.Rmd", 
                          "ugga_qaqc_2018_2025.R", 
                          "ugga_FluxCalR_2025.R"),
       ...
       #                        "Data processing script for 2024"),
         other.entity.description = c(#'Raw data from the Ultraportable Greenhouse Gas Analyzer', 
                                      "Code used to visualize UGGA data from 2018-2025",
                                      "Code used to compile and format 2018-2025 data (after data processing)",
                                      "Code used to process raw 2025 files"),
         temporal.coverage = c("2018-05-07", "2025-12-01"),
         maintenance.description = "ongoing",
         user.domain = "EDI",
         user.id = "ccarey",
         package.id = "edi.1103.2") # this is for staging !
