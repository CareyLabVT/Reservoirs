...
current_starttime = as.Date("2025-01-01")
current_endtime = as.Date("2025-12-31")
```


```{r Make the qaqced data frame, eval=T, include=FALSE}
...
```{r READ IN EDI FOR REVIEWER, eval=T, include=FALSE}
...
# MAKE SURE TO UPDATE THE PASTA FROM THE VERSION YOU WANT. 
                                                                ### CHANGE THIS NUMBER BELOW 
                                                                             ##      
 current_df <-read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/1102/13/b38441dbea377f89ab5745aca09cd355")

current_year = "2025-01-01"
...
write.csv(current_df, "ugga_2018_2025.csv", row.names = FALSE)


```

```{r Download relavant files, eval=FALSE, include=T}

# Maintenance Log
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/refs/heads/master/Data/DataNotYetUploadedToEDI/UGGA/UGGA_Maintenance_Log.csv", "ugga_maintenancelog_2018_2025.csv")

# qaqc function
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/refs/heads/master/Scripts/L1_functions/UGGA_create.R", "ugga_qaqc_2018_2025.R")

# helper script to process the UGGA files
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/refs/heads/master/Data/DataNotYetUploadedToEDI/UGGA/UGGA_Raw/2025/FluxCalR_2025.R", "ugga_FluxCalR_2025.R")

```

```{r Site description file, include=FALSE}
