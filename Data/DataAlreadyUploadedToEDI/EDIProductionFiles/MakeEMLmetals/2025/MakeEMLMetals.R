...
make_eml(
  ...
  other.entity.description = c("QAQC script which takes the output from ICPMS, cleans data, and flags errant data", 'Script that uses Metals_qaqc_2020_2024.R script to create the final dataframe and plots the data', 'Function to create output plots utilized by visual inspection script'),
  user.id = 'mschreib',
  user.domain = 'EDI',
  package.id = 'edi.718.9') # This package identifier is only for the staging environment
