...
historic = "https://raw.githubusercontent.com/CareyLabVT/Reservoirs/refs/heads/master/Data/DataNotYetUploadedToEDI/Metals_Data/Raw_Data/historic_raw_2014_2019_w_unique_samp_campaign.csv",
 ...
 MRL_file = "https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Data/DataNotYetUploadedToEDI/Metals_Data/MRL_metals.txt",
         ...
         ISCO_outfile = NULL, # put Null to return the file
...
```{r QAQC file or READ IN EDI FOR REVIEWER, eval=FALSE, include=FALSE}
...
# make the plots
outputs <- lapply(dx, all_plot, data=current_df, reservoir = "FCR", res_site=50, y_lab = "mg/L", y_lab2 = "mg/L",Depth=T, Water=F, Use_plotly=T, Heatmap = F)
...
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Scripts/L1_generation_scripts/metals_qaqc.R", "Metals_qaqc_2020_2024.R")
...
```{r Make site description file, include=FALSE}
