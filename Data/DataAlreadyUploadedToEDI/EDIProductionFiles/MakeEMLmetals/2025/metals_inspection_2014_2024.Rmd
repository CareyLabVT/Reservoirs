...
TThis script is the visual inspection script. 
...
current_df <- metals_qaqc(directory = "../../../../DataNotYetUploadedToEDI/Metals_Data/Raw_Data/2024",
...
```{r Make new CSV with current and historic files, eval=TRUE, include=FALSE}
...
```{r Download and save Maintenance Log, eval=TRUE, include=FALSE}
...
download.file("https://raw.githubusercontent.com/CareyLabVT/Reservoirs/master/Scripts/L1_functions/metals_create.R", "metals_qaqc_2020_2024.R")
