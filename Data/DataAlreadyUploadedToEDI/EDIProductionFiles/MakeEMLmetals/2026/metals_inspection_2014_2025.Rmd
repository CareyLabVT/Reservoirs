...
# source('https://raw.githubusercontent.com/ceceliawood/MiscGradSchool/refs/heads/main/Plotting_function_CEW.R') # same function but no density plots
...
Let's look at the flag Frequency for each variable. As a reminder here are the flag codes
 ...
 3: sample below MRL or negative and set to MRL
 
 4: non-standard method (digested)
 
 5: sample run multiple times and values averaged
 
 6: suspect value
 
 7: total and soluble samples switched prior to analysis; fixed in QAQC
 
 8: improper procedure and set to NA
 
 9: soluble is greater than the total
