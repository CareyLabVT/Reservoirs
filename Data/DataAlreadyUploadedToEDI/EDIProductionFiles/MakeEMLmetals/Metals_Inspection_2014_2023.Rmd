...
```{r QAQC FCR 50 Plots, echo=FALSE, warning=FALSE, results='asis'}
...
```{r QAQC FCR 100 Plots, echo=FALSE, warning=FALSE, results='asis'}
...
outputs <- lapply(dx, all_plot, data=current_df, reservoir = "BVR", res_site=50, y_lab = "mg/L", y_lab2 = "mg/L",Depth=T, Water=F, Use_plotly=F, Heatmap = T)
...
```{r Make new CSV with current and historic files, eval=FALSE, include=TRUE}
...
```{r Download and save Maintenance Log, eval=FALSE, include=TRUE}
