...
sum_plot4 = chem_full%>%
  ...
  mutate(name = factor(name, levels=c("Phosphorus","Nitrogen","TNTP","Phyto","DOC_mgL","co2_umolL")),
         color = factor(color, levels=c("TP_ugL","PO4_ugL","TotalConc_ugL","Bluegreens_ugL","DOC_mgL","co2_umolL","NH4_ugL","TN_ugL","TNTP"),
                        labels=c("TP_ugL","PO4_ugL","TotalConc_ugL","Bluegreens_ugL","DOC_mgL","co2_umolL","NH4_ugL","TN_ugL","TNTP")))
...
names(my_colors)=c("TP_ugL","PO4_ugL","TotalConc_ugL","Bluegreens_ugL","DOC_mgL","co2_umolL","NH4_ugL","TN_ugL","NO3NO2_ugL","TNTP")
...
sum_plot4%>%
  ...
  geom_vline(aes(xintercept = max_date, color = color), data = maxes, lwd = 2, alpha = 0.5, show.legend = F)+
  #geom_vline(data=lines,aes(xintercept = Dates, lty = status), show.legend = F)+
  scale_linetype_manual(values = c("solid","11","solid","11","solid","solid","11","solid","solid"))+
