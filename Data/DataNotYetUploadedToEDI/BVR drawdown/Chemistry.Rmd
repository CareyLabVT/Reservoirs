...
sum_plot3%>%
  ...
  force_panelsizes(rows = unit(1, "in"),
                   cols = unit(2.5, "in"))
ggsave("./Figs/Abby_money_plot_biogeo.jpeg", dpi = 300, width = 6.5, height = 5)
...
sum_plot4%>%
  ...
  force_panelsizes(rows = unit(1, "in"),
                   cols = unit(2.5, "in"))
ggsave("./Figs/Abby_money_plot_doc.jpeg", dpi = 300, width = 6.5, height = 8.5)
...
sum_plot5%>%
  ...
  force_panelsizes(rows = unit(1, "in"),
                   cols = unit(2.5, "in"))
ggsave("./Figs/Abby_money_plot_phytos.jpeg", dpi = 300, width = 6.5, height = 5)
```
