...
sum_plot4 = chem_full%>%
  ...
  mutate(name = factor(name, levels=c("Phosphorus","Nitrogen","Phyto","DOC_mgL","co2_umolL")),
         color = factor(color, levels=c("TP_ugL","PO4_ugL","TotalConc_ugL","Bluegreens_ugL","DOC_mgL","co2_umolL","NH4_ugL","TN_ugL"),
                        labels=c("TP_ugL","PO4_ugL","TotalConc_ugL","Bluegreens_ugL","DOC_mgL","co2_umolL","NH4_ugL","TN_ugL")))
...
my_colors = c("black","grey50","darkgreen","turquoise","blue","#8E4412","skyblue","magenta4","pink")
names(my_colors)=c("TP_ugL","PO4_ugL","TotalConc_ugL","Bluegreens_ugL","DOC_mgL","co2_umolL","NH4_ugL","TN_ugL","NO3NO2_ugL")

sum_plot4%>%
  ggplot()+
  geom_rect(aes(xmin = opened,xmax = closed,ymin=-Inf,ymax=Inf),fill = "grey40", data = lines_rect, alpha = 0.2)+
  geom_point(aes(y = value, x = DateTime,color = color))+
  geom_line(aes(y = value, lty=lty,x = DateTime,color = color))+
  geom_vline(aes(xintercept = max_date, color = color), data = maxes, lwd = 2, alpha = 0.5, show.legend = F)+
  #geom_vline(data=lines,aes(xintercept = Dates, lty = status), show.legend = F)+
