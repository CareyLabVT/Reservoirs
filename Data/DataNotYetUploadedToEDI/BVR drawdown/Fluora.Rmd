...
title: "Fluoro"
author: "Abby Lewis"
date: "Last updated: 2022-10-14 MEL"
...
Cmax <- matrix(data=NA, ncol=6, nrow=38)
...
colnames(Cmax) <- c("Date","green","cyano","diatom","crypto","total")
...
ggplot(data = Cmax, aes(x = spectral_group, y = Cmax_depth, fill = as.factor(Year)))+
  geom_boxplot()+
  scale_y_reverse()+
  theme_classic()+
  xlab("Spectral group")+
...
#should probably think about this relative to photic zone depth and/or thermocline depth --> are these already calculated?
