...
# if not pull in the file path from EDI


# read in the data file downloaded from EDI
dt2 <-read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/692/14/311d766dd7275d578699380f8996f089") 

#ec <- dt2%>%
#  bind_rows(.,dt1)

#FOR USING YEAR-ROUND UPLOADED DATA FROM EDI
ec <- dt2
```
...
met_all <- read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/143/33/62647ecf8525cdfc069b8aaee14c0478",
