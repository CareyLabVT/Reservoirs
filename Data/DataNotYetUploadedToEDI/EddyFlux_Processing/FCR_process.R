...
ec <- read_csv("C:/Users/Panasonic/Documents/Falling creek reservoir data/compiled_eddy/FCR_2021-05-06_upto.csv")
...
ts <- seq.POSIXt(as.POSIXct("2020-04-04 11:30:00",'%Y-%m-%d %H:%M:%S'), 
                 as.POSIXct("2021-05-06 13:30:00",'%Y-%m-%d %H:%M:%S'), by = "30 min")
...
met <- read_csv('~/Falling creek reservoir data/met_data.csv')
...
cat <- read_csv('~/Falling creek reservoir data/catwalk_data.csv')
