...
jpeg(paste0(output_file),width = 8, height = 4, units = "in", res = 300)
water_temp <- data%>%
  ...
  geom_point(data = sample_dates, aes(x = MDay, y = 0.1, z = NULL), pch = 25, size = 4, color = "white", fill = "black")+ #to mark cast dates 
   geom_textvline(data= turnovers, aes(xintercept=MDay) ,label="Turnover", linetype="solid", linewidth=2, color="purple", size=4)+
