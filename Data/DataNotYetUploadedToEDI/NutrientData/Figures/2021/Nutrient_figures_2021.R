#Script to visualize 2021 collated TN/TP, np, and DOC data 

#install.packages('pacman')
pacman::p_load(tidyverse, lubridate, scales, viridis)

#load in collated 2019 data 
raw_chem <- read.csv("./FinalData/2021_chemistry_collation_final_nocommas.csv")
...
#jpeg("./Figures/2021/FCR_BVR_CCR_all_nutrients_summer2021.jpg", width = 6, height = 5, units = "in",res = 300)
...
#jpeg("./Figures/2021/FCR_all_nutrients_summer2021.jpg", width = 6, height = 5, units = "in",res = 300)
...
#jpeg("./Figures/2021/FCR_sites_all_nutrients_summer2021.jpg", width = 6, height = 5, units = "in",res = 300)
...
#jpeg("./Figures/2021/BVR_all_nutrients_summer2021.jpg", width = 6, height = 5, units = "in",res = 300)
...
#jpeg("./Figures/2021/CCR_sites_all_nutrients_summer2021.jpg", width = 6, height = 5, units = "in",res = 300)
ggplot(subset(chemistry_long, Reservoir=='CCR' & Site!="50"), aes(x = DateTime, y = value, col=as.factor(Site))) +
  ...
  scale_y_continuous("Concentration") +
  theme(axis.text.x = element_text(angle = 45, hjust=1)) + 
  scale_color_manual("CCR_Site", values = plasma(13)) 
#dev.off()
