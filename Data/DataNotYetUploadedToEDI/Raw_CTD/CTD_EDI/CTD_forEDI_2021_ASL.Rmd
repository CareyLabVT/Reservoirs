...
BVR cast on 18/19 July 2019 is actually FCR!!! (and generally need to make sure all casts are labeled as the right reservoir)
Need to fix 2021 times
Make sure all 2019 MSN data is here
Oxygen flags for 2022?
Why are these omitted "090419_bvr50.csv","090419_fcr50.csv"
filter(Date != "2020-07-19T21:02:02Z") from last year. No! This is just a BVR cast! Need to add it back
Are we missing FCR data in late june/ early july?
2020-07-17 FCR has very high orp
...
omit <- c("100719_bvr_sedtrap.csv","090419_bvr50.csv","090419_fcr50.csv","ctd_short_for_GLM_AED_2019.csv","CTD_Meta_13_19.csv","CTD_Meta_2019.csv", "072121_fcr50_sit_1.6m.csv")#fill in with any files you need to omit
...
files <- c(files,"071819_fcr50.csv","071819_bvr50.csv") #Reprocessing these files in 2021
