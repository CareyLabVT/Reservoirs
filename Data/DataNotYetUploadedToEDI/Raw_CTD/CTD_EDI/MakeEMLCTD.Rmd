...
make_eml(path = getwd(),
         ...
         data.table = "CTD_final_2013_2020.csv",
         data.table.name = c("CTD dataset 2013-2020"),
         data.table.description = c("Reservoir CTD dataset"),
         other.entity = 'CTD_forEDI_ASL.Rmd',
         other.entity.name = c('CTD QAQC script'),
         other.entity.description = c('QAQC script for reference'),
         temporal.coverage = c("2013-03-07", "2020-12-31"),
         maintenance.description = "ongoing",
         user.domain = "EDI",
         user.id = "ccarey",
         package.id = "edi.129.1")
```
