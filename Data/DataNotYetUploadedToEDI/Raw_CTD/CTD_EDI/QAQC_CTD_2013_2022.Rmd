...
#2019 (and some 2020) flags are messed up. Need to check things other than conductivity too
dt1%>%
  filter(is.na(Flag_Cond))

#I think there are some things that are flagged as set to 0 but actually NA
```
