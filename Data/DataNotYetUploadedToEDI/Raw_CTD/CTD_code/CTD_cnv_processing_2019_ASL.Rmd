...
<<<<<<< HEAD
DATE_TEXT <- "16-Jun-2021" #format should be "01-Aug-2019"
SITE <- "bvr50"
=======
DATE_TEXT <- "11-Jun-2021" #format should be "01-Aug-2019"
SITE <- "fcr50"
>>>>>>> 33e063a7b0d1acbabb1929a3dfe2b578fb1c0236
SAMPLER <- ""
...
<<<<<<< HEAD
REP <- "_0003" #If multiple casts were taken this will be _a, _b, _c, etc. Be sure to include an underscore if there is one in the file name
=======
REP <- "_0008" #If multiple casts were taken this will be _a, _b, _c, etc. Be sure to include an underscore if there is one in the file name
>>>>>>> 33e063a7b0d1acbabb1929a3dfe2b578fb1c0236
...
if(SITE %in% c("fcr50", "bvr50")){
  ...
  if(catwalk_compare == T){
      ctd_vs_catwalk(on,off, SITE, startDate = "2021-06-10 12:00:00") #This step takes a couple minutes
  }
}
```
