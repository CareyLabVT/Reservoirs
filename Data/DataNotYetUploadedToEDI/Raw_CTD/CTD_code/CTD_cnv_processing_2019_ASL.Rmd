...
DATE_TEXT <- "21-Sep-2020" #format should be "01-Aug-2019"
SITE <- "fcr50"
SAMPLER <- ""
...
on = as_datetime(c("")) #July time is estimated based on the time for other sampling. TZ is UTC to match catwalk and current CTD processing
off = as_datetime(c("")) #July date is wrong bc system broke. TZ is UTC to match catwalk and current CTD processing
