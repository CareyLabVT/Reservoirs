...
DATE_TEXT <- "26-Jul-2021" #format should be "01-Aug-2019"
SITE <- "bvr_50"
SAMPLER <- ""
...
REP <- "_0001" #If multiple casts were taken this will be _a, _b, _c, etc. Be sure to include an underscore if there is one in the file name
