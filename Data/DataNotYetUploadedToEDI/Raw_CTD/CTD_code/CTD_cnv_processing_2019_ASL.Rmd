...
DATE_TEXT <- "21-Jul-2021" #format should be "01-Aug-2019"
SITE <- "fcr50"
SAMPLER <- ""
...
REP <- "_sit_1.6m" #If multiple casts were taken this will be _a, _b, _c, etc. Be sure to include an underscore if there is one in the file name
