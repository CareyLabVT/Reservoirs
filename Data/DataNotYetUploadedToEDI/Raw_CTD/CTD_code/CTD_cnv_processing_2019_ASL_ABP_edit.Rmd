...
REP <- "_S8188003" #If multiple casts were taken this will be _a, _b, _c, etc. Be sure to include an underscore if there is one in the file name
...
#  if(year(as.Date(DATE_TEXT, format = "%d-%b-%Y")) == 2022){
