...
DATE_TEXT <- "15-Jul-2022" #format should be "01-Aug-2019"
SITE <- "bvr50"
SAMPLER <- ""
...
REP <- "_S8188001" #If multiple casts were taken this will be _a, _b, _c, etc. Be sure to include an underscore if there is one in the file name
