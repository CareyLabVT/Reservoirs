...
ghgs_reps <- ghgs_reps %>% 
  mutate(flag_ch4 = ifelse(ch4_pdiff>=50 & ch4_diff>=0.002,3,
                           ifelse(ch4_pdiff<=50 & ch4_pdiff>=30 & ch4_diff>=0.002,2,
                                  1)))

ghgs_reps <- ghgs_reps %>% 
  mutate(flag_co2 = ifelse(co2_pdiff>=50 & co2_diff>=3.8,3,
                           ifelse(co2_pdiff<=50 & co2_pdiff>=30 & co2_diff>=3.8,2,
                                  1)))
