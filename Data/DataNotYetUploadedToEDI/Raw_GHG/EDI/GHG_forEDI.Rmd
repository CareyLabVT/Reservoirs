...
ghgs_comb_2 <- ghgs_comb_2 %>% 
  mutate(flag_co2 = ifelse(co2_umolL == 0 & is.na(ghgs_comb_2$flag_co2),5,ghgs_comb_2$flag_co2)) %>% 
  mutate(flag_ch4 = ifelse(ch4_umolL == 0 & is.na(ghgs_comb_2$flag_ch4),5,ghgs_comb_2$flag_ch4))
```
