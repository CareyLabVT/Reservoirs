...
2. Add in column for site? To mimic other datasets?
3. Add in early 2020 data
4. How best to automate/remove bad reps?
...
This section graphs CO2 and CH4, and creates a combined file to publish to EDI
```{r}
