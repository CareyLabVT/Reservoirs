...
library(stringr)
#add sed flux
setwd('~/Documents/GitHub/Reservoirs/Data/DataNotYetUploadedToEDI/Sed_trap/EDI')
...
flux_summary <- fluxes %>% 
  select(Reservoir, Date, Depth_m, SedFlux_gm2d, TFeFlux_gm2d, TMnFlux_gm2d, TOCFlux_gm2d, TNFlux_gm2d,
         Flag_CombinedCollectionVol_L, Flag_Duration_days, Flag_Filter2ID, Flag_CombinedSedMass_g) %>% 
...
#remove NaN created by summarise function
...
flux_summary <- flux_summary %>% 
  mutate(Flag_TFeFlux_gm2d = 1,
         Flag_TFeFlux_gm2d = ifelse(Date > '2020-01-01', 3, Flag_TFeFlux_gm2d),
         Flag_TFeFlux_gm2d = ifelse(Flag_CombinedCollectionVol_L != 1 | Flag_Duration_days != 1 | Flag_Filter2ID != 1 | Flag_CombinedSedMass_g != 1, 4, Flag_TFeFlux_gm2d),
         Flag_TFeFlux_gm2d = ifelse((Flag_CombinedCollectionVol_L != 1 | Flag_Duration_days != 1 | Flag_Filter2ID != 1 | Flag_CombinedSedMass_g != 1) & Date > '2020-01-01', 5, Flag_TFeFlux_gm2d),
         Flag_TFeFlux_gm2d = ifelse(is.na(TFeFlux_gm2d), 2, Flag_TFeFlux_gm2d),
         Flag_TMnFlux_gm2d = 1,
         Flag_TMnFlux_gm2d = ifelse(Date > '2020-01-01', 3, Flag_TMnFlux_gm2d),
         Flag_TMnFlux_gm2d = ifelse(Flag_CombinedCollectionVol_L != 1 | Flag_Duration_days != 1 | Flag_Filter2ID != 1 | Flag_CombinedSedMass_g != 1, 4, Flag_TMnFlux_gm2d),
         Flag_TMnFlux_gm2d = ifelse((Flag_CombinedCollectionVol_L != 1 | Flag_Duration_days != 1 | Flag_Filter2ID != 1 | Flag_CombinedSedMass_g != 1) & Date > '2020-01-01', 5, Flag_TMnFlux_gm2d),
         Flag_TMnFlux_gm2d = ifelse(is.na(TMnFlux_gm2d), 2, Flag_TMnFlux_gm2d),
         Flag_TOCFlux_gm2d = 1,
         Flag_TOCFlux_gm2d = ifelse(Flag_CombinedCollectionVol_L != 1 | Flag_Duration_days != 1 | Flag_Filter2ID != 1 | Flag_CombinedSedMass_g != 1, 3, Flag_TOCFlux_gm2d),
         Flag_TOCFlux_gm2d = ifelse(is.na(TOCFlux_gm2d), 2, Flag_TOCFlux_gm2d),
         Flag_TNFlux_gm2d = 1,
         Flag_TOCFlux_gm2d = ifelse(Flag_CombinedCollectionVol_L != 1 | Flag_Duration_days != 1 | Flag_Filter2ID != 1 | Flag_CombinedSedMass_g != 1, 3, Flag_TNFlux_gm2d),
         Flag_TNFlux_gm2d = ifelse(is.na(TNFlux_gm2d), 2, Flag_TNFlux_gm2d),
         Flag_AvgSedFlux_gm2d = 1,
         Flag_AvgSedFlux_gm2d = ifelse(Flag_CombinedCollectionVol_L != 1 | Flag_Duration_days != 1 | Flag_Filter2ID != 1 | Flag_CombinedSedMass_g != 1, 3, Flag_SedFlux_gm2d),
         Flag_AvgSedFlux_gm2d = ifelse(is.na(AvgSedFlux_gm2d), 2, Flag_SedFlux_gm2d)) %>% 
...
write_csv(flux_summary, file = '~/Documents/GitHub/Reservoirs/Data/DataNotYetUploadedToEDI/Sed_trap/EDI/FluxSummary.csv')
