...
ugga_flagged = ugga_comb%>%
  ...
  mutate(Start_time = ifelse(year(Date)==2022,NA,Start_time),
         End_time = ifelse(year(Date)==2022,NA,End_time),
         Flag_Start_time = ifelse(is.na(Start_time),1,0),
         Flag_End_time = ifelse(is.na(End_time),1,0))
