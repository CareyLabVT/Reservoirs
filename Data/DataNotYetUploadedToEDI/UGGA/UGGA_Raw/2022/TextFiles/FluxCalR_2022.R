...
#wd <- setwd("~/Desktop/Reservoirs/Data/DataNotYetUploadedToEDI/UGGA/UGGA_Raw/2022/TextFiles")
wd <- setwd("~/Desktop/github/Reservoirs/Data/DataNotYetUploadedToEDI/UGGA/UGGA_Raw/2022/TextFiles")
...
flux_lgr_4 <- LoadLGR(file ="./gga_2001-12-31_f0027.txt",
                      time_format = "mdy_HMS")
flux_lgr_5 <- LoadLGR(file ="./gga_2001-12-31_f0025.txt",
                      time_format = "mdy_HMS")%>%
  filter(year(Time)>2020)
